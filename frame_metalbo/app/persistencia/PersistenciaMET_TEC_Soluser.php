 ...
 * @since 14/07/2017
 */
class PersistenciaMET_TEC_Soluser extends Persistencia {

    public function __construct() {
        parent::__construct();

        $this->setTabela('MET_TEC_soluser');
    ...
    public function insereSol() {
        ...
        $sSql = "insert into MET_TEC_soluser (usucodigo,usunome,ususobrenome,usulogin,usuemail,ususit,obs,dataSolUser)
