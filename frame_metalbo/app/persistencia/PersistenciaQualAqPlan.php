 ...
 */
class PersistenciaQualAqPlan extends Persistencia {
    ...
    public function inserAq($aCampos) {
        ...
        $sInsert = "insert into tbacaoqualplan (filcgc,nr,seq,plano,dataprev,anexoplan1,usucodigo,usunome,tipo,nrEfi)
    ...
    public function apontaPlano() {
        ...
        $sSql = "update tbacaoqualplan set funcao='" . $aCampos['funcao'] . "',treinamento='" . $aCampos['treinamento'] . "',preventiva='" . $aCampos['preventiva'] . "',"
    ...
    public function buscaParam($aDados) {
        $sSql = "select * from tbacaoqualplan where filcgc = '" . $aDados[0] . "' and nr = '" . $aDados[1] . "' and seq = '" . $aDados[2] . "' ";
