...
class PersistenciaMET_GerenciaFrete extends Persistencia {
    ...
    public function __construct() {
        ...
        $this->adicionaRelacionamento('valorserv2', 'valorserv2');
        $this->adicionaRelacionamento('valorserv3', 'valorserv3');
    ...
    public function verificaConhec($aValores) {
        $sSql = "select count(nrconhe) as total from tbgerecfrete where nrconhe like '" . $aValores['nrconhe'] . "' "
...
//    }
    ...
    public function consultaDadosFormulas($aValores) {
        ...
        if ($aValores['cnpj'] == '10882366000195') {
            ...
            $sSqlAux = "select " . $aValores['cnpj'] . " as cnpj, " . $aValores['nrnotaoc'] . " as nota, "
                    . $aValores['totalnf'] . " as nfsvlrtot, " . $aValores['totakg'] . " as pesoNota, "
    ...
    /**
     * Método que retorna a parcela de frete
     * @param type $oVal
     * @return int
     */
