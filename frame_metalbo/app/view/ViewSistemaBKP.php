    ...
    function constroiTelaInicial() {
        ...
        $sTela = '<!DOCTYPE html>'
               ...
               .'<link rel="stylesheet" type="text/css" href="biblioteca/tagsinput/src/jquery.tagsinput.css" />'
                ...
                . '<a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false" data-animation="fade" role="button"><i class="icon fa-stack-overflow" aria-hidden="true"></i> Módulos</a>'
