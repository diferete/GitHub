...
class ViewMET_GerenciaFrete extends View {
    ...
    public function criaConsulta() {
        ...
        $oFiltroCnpj = new Filtro($oCnpj, Filtro::CAMPO_SELECT, 3, 3, 12, 12, false);
        ...
        $oFiltroDtEmFat = new Filtro($oDatEm, Filtro::CAMPO_TEXTO, 1, 1, 12, 12, false);
        $oFiltroDtVnFat = new Filtro($oDatVenc, Filtro:: CAMPO_TEXTO, 1, 1, 12, 12, false);
        $oFiltroTipo = new Filtro($oCodTipo, Filtro::CAMPO_SELECT, 1, 1, 12, 12, false);
        ...
        $oFiltroSitu = new Filtro($oSit, Filtro::CAMPO_SELECT, 1, 1, 12, 12, false);
    ...
    public function criaTela() {
        ...
        //Filtro de células
        $oCnpj = new Campo('CNPJ', 'cnpj', Campo::CAMPO_SELECT, 5);
        foreach ($aDados as $key) {
            $val = (int) $key['cnpj'];
        ...
        $oNrCon->addValidacao(false, Validacao::TIPO_STRING);
        ...
        $oValSer->addValidacao(false, Validacao::TIPO_STRING);
        ...
        $sDataEm->addValidacao(false, Validacao::TIPO_STRING);

        $sDataFn = new Campo('Data de Vencimento', 'datafn', Campo::TIPO_DATA, 2);
        $sDataFn->setId('gerenciafrete_datafn');
        $sDataFn->addValidacao(false, Validacao::TIPO_STRING);
