...
class ViewMET_GerenciaFrete extends View {
    ...
    public function criaConsulta() {
        ...
        $oFiltroSitu = new Filtro($oSit, Filtro::CAMPO_SELECT, 1, 1, 12, 12, true);
        ...
        $oFiltroDtEmFat = new Filtro($oDatEm, Filtro::CAMPO_DATA, 1, 1, 12, 12, false);

        $oFiltroDtVnFat = new Filtro($oDatVenc, Filtro:: CAMPO_DATA, 1, 1, 12, 12, false);
    ...
    public function criaTela() {
        ...
        $oBtnConsultaFrete = new Campo('Fretes', 'Fretes', Campo::TIPO_BOTAO_MOSTRACONSULTA, 1, 1, 12, 12);
        $oBtnConsultaFrete->setClasseBusca('MET_GerenciaFrete');
        $oBtnConsultaFrete->setSIdTela($this->getTela()->getId());
        $oBtnConsultaFrete->setIMarginTop(17);

        $this->addCampos(array($oNr, $oCnpj, $oNrFat, $sDataEm, $sDataFn, $oBtnConsultaFrete), $oL, array($oCodtip, $oNrCon, $oNrNot, $oTotalNf, $oTotalKg, $oFracaoFrete, $oValSer, $oSit), $oL, $oSeqReg, $oValorServ2, $oValorServ3, $oGridFrete, $oL, array($oDat, $oHora, $oUser), $oL, $oObs);
    }
