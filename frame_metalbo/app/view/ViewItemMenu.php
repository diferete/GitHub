 ...
 * 
 */
class ViewItemMenu extends View {

    function __construct() {
        parent::__construct();

        $this->setController('ItemMenu');
    ...
    function criaGridDetalhe() {
        ...
        $oMenuG = new CampoConsulta('Menu', 'Menu.mencodigo');
        $oMenuDesG = new CampoConsulta('Menu Desc.', 'Menu.mendes');
    ...
    function criaConsulta() {
        ...
        $oMenu = new CampoConsulta('Menu', 'Menu.mencodigo');
        $oMenuDes = new CampoConsulta('Menu Desc.', 'Menu.mendes');
