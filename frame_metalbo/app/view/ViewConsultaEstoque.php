    ...
    public function __construct() {
     ...
     function criaTela(){
        ...
        //grid que lista os produtos
         ...
         if($bVisualizaEmpenho){
          $this->addCampos($oFieldGrupo,
                array($oCodigo,$oBtnBuscar),$oGridProdutos,array($oGridEstoque,$oPedAberto,$oSaldoPed,$oBtnEmpenho,$oOf),$oFildEmb);
         }else{
           $this->addCampos($oFieldGrupo,
                array($oCodigo,$oBtnBuscar),$oGridProdutos,array($oGridEstoque,$oPedAberto,$oSaldoPed,$oOf),$oFildEmb);   
         }
    }
