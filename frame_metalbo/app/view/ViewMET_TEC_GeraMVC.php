...
class ViewMET_TEC_GeraMVC extends View {
    ...
    public function criaTela() {
        ...
        //Se deverá ter ou não a nomenclatura no nome das classes
        $oNomenclatura = new Campo ("Sem Nomenclatura", 'nomclat', Campo::TIPO_CHECK, 2, 2, 12, 12);
        
        //Se deverá ter ou não os campos na classe view
        $oCamposView = new Campo ("Sem Campos na View", 'viewcamp', Campo::TIPO_CHECK, 2, 2, 12, 12);
        ...
        $this->addCampos($oNomeMVC, $oLinha1, $oNomeTabela, $oLinha1, $oFrame, $oLinha1, $oNomenclatura, $oLinha1, $oCamposView, $oLinha1, $oBotaoExecuta);
