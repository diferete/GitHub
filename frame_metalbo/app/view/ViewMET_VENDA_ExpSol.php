...
class ViewMET_VENDA_ExpSol extends View {
    ...
    public function criaTela() {
        ...
        $sCallBackCnpj = 'if(requestJSON(false, "MET_VENDA_ExpSol","verifBloqCred", $("#' . $this->getTela()->getId() . '-form").serialize(), "' . $oCnpj->getNome() . '").retorno == "false"){;'
        ...
        $oCodPagDes->addEvento(Campo::EVENTO_SAIR, 'var oCnpj=$("#' . $oCnpj->getId() . '").val(); requestAjax("","MET_VENDA_ExpSol","carregaRep","' . $oCodRed->getId() . ',' . $oRep->getId() . ',"+oCnpj+"","");');
