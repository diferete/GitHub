...
class ViewMovFornoSteel extends View {
    ...
    public function criaConsulta() {
        ...
        $oSit->addComparacao('Processo', CampoConsulta::COMPARACAO_IGUAL, CampoConsulta::COR_AZUL, CampoConsulta::MODO_LINHA, false, null);
        ...
        $oFiltroForno = new Filtro($oForno, Filtro::CAMPO_SELECT, 2, 2, 12, 12, false);
        ...
        $oFiltroSit = new Filtro($oSit, Filtro::CAMPO_SELECT, 2, 2, 12, 12, false);
