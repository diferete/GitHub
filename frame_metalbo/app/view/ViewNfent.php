...
class ViewNfent extends View{
    ...
    public function criaConsulta() {
        ...
        $oDrop1->addItemDropdown($this->addIcone(Base::ICON_CONFIG).'Adiciona Financeiro','Contpagar', 'acaoMostraTelaIncluir', '',true);
        ...
        $oFRazao = new Filtro($oPesRazao, Filtro::CAMPO_TEXTO,3);
    ...
    public function criaTela() {
       ...
       $oNfTotProd->addEvento(Campo::EVENTO_SAIR, 'var vlrprod = $("#'.$oNfTotProd->getId().'").val();'
        ...
        $this->addCampos($oNfEmp,array($oNfDoc,$oNfSerie,$oNfCnpj,$oEmpresa,$oSitNf),array($oNfDataEnt,$oNfDataCheg,$oNfHoraCheg,$oNfTipo),
                $oFieldValores,$oNfobs,array($oUsuIns,$oUsuHoraCad));
    }
}