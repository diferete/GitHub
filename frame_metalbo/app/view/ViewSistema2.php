...
class ViewSistema extends View{
    ...
    function constroiTelaInicial(){
        ...
        .'<script>'
          ...
          .'        <img class="navbar-brand-logo" id="logo" src="biblioteca/assets/images/logo.png" title="MegaMobi">'
          ...
          .'  data-animation="fade" role="button">Módulos do sistema<i class="icon wb-chevron-down-mini" aria-hidden="true"></i></a>'
          ...
          */
          ...
          .'                <img src="Uploads/'.$_SESSION["usuimagem"].'" style="height: 30px;">'
          .'                <i></i>'
          .'              </span>'
          .'            </a>'
          .'            <ul class="dropdown-menu" role="menu">'
          .'              <li role="presentation">'
          .'                <a href="javascript:void(0)" role="menuitem" onclick="verificaTab(\'menu-1-p\',\'1-p\',\'Profile\',\'acaoMostraTelaAlterar\',\'usucodigo='.$_SESSION["codUser"].',tabmenu-1-pcontrol\',\'Profile\');"><i class="icon wb-user" aria-hidden="true"></i> Perfil</a>'
          .'              </li>'
         /* .'              <li role="presentation">'
...
//         .'     </div>'
      ...
      /*   .'   <div class="site-gridmenu">'
       ...
       /*  .'   <footer class="site-footer">'
         ...
         .'     </div>'
         .'   </footer>'*///footer desativado por enquanto
        .'      <!-- File Input-->'
...
//         .'<!-- File Upload -->'
//         .'<script src="biblioteca/assets/js/jquery.ui.widget.js" type="text/javascript"></script>'
//         .'<script src="biblioteca/assets/js/jquery.iframe-transport.js" type="text/javascript"></script>'
//         .'<script src="biblioteca/assets/js/jquery.fileupload.js" type="text/javascript"></script>'
//       
        ...
        .'<link rel="stylesheet" href="biblioteca/assets/vendor/formvalidation/formValidation.css">'        
         ...
         .'         Site.run();'
         .'             toastr["success"]("SISTEMA MEGAMOBI ON LINE", "PRONTO!");'
       ...
       foreach ($aMenu as $key => $aMenuSup) {
          $sEstruturaMenu .='<li class="site-menu-item has-sub">'
              ...
              foreach ($aSub as $key => $aSupItem)  {
                ...
                .'  <a href="#" data-slug="layout-menu-collapsed" onclick="verificaTab(\'menu-'.$iMenuId.'\',\''.$iMenuId.'\',\''.$aSupItem[1].'\',\''.$aSupItem[2].'\',\'tabmenu-'.$iMenuId.'\'); ">' //requestAjax(\''.$iMenuId.'\',\''.$aSupItem[1].'\',\''.$aSupItem[2].'\',\'tabmenu-'.$iMenuId.'\');
   ...
   public function MontaTab(){
      ...
      ."$('#tabmenusuperior > li').each(function(){"
       ...
       ."if(addnewtab=='s'){ "
           ." newTab(id,tela);"
           ."requestAjax(iMenuId, SupItem1, SupItem2, tab);"
  ...
  //   ."alert(countTabs);"
     ."     }); "
     ." if(countTabs==1){showPerfil();} "//$('#teste').hide()
     ."}"
     ."function showPerfil(){"
     //   ."alert('chegou no show perfil');"
        ."$('#perfilPrincipal').toggle();"
     ."}";
    ...
    public function montaModulo(){
        ...
        foreach ($aModulos as $value) {
          $sModulos .= ' <a class="list-group-item blue-grey-500" href="javascript:void(0)" onclick="requestAjax(\'\',\'Menu\',\'recarregaMenu\',\''.$value[1].'\')">'
                       .'       <i class="icon wb-inbox" aria-hidden="true"></i> '.$value[0].''
                       .'     </a> ';
          }
         return $sModulos;
    ...
    public function montMsgInicial(){
        $sMsg = '<div class="example-wrap" id="perfilPrincipal">'
         ...
         .'        <a target="_blank" href="http://www.megamobi.com.br">www.megamobi.com.br</a></br> '
         .'       <a target="_blank" href="https://www.facebook.com/megamobiti/"> <button type="button" class="btn btn-labeled btn-xs social-facebook"> '
         ...
         .'             src="Uploads/'.$_SESSION["usuimagem"].'"> '       
         .'       </p>'
         .'     </div>'
         .'   </div>'
         ...
         //"Uploads/'.$_SESSION["imgProfileNav"].'"
        return $sMsg;
    }
}
