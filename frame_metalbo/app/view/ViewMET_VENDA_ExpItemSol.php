...
class ViewMET_VENDA_ExpItemSol extends View {

    public function __construct() {
        parent::__construct();
        $this->setController('MET_VENDA_ExpItemSol');
    ...
    public function criaTela() {
        ...
        //campo desconto
        $oDesconto = new Campo('Desc', 'desconto', Campo::TIPO_TEXTO, 1);
        ...
        $oTratamento = new Campo('Trat', 'desctrat', Campo::TIPO_TEXTO, 1);
        ...
        $oDescExtra1 = new Campo('Desc1', 'descextra1', Campo::TIPO_TEXTO, 1);
        ...
        $oDescExtra2 = new Campo('Desc2', 'descextra2', Campo::TIPO_TEXTO, 1);
        ...
        $oLibPrcKg = new Campo('RegraLiberação', 'prcKg', Campo::TIPO_TEXTO, 2);
        $oLibPrcKg->setBCampoBloqueado(true);
        $oLibPrcKg->setSValor('Negado');
        $oLibPrcKg->setITamanho(Campo::TAMANHO_PEQUENO);

        $oLoteMinimo = new campo('LoteMínimo', 'lotemin', Campo::TIPO_TEXTO, 2);
        $oLoteMinimo->setBCampoBloqueado(true);
        $oLoteMinimo->setSValor('0');

        $oSolLib = new Campo('SolicitaLiberação', 'sollib', Campo::TIPO_BOTAOSMALL, 1);
        ...
        $oCodigo->addEvento(Campo::EVENTO_SAIR, 'entradaCodigo("' . $oVlrUnit->getId() . '"); var oProcod=$("#' . $oCodigo->getId() . '").val(); var prcTabela =$("#' . $oPrcBruto->getId() . '").val(); var prcUnit =$("#' . $oVlrUnit->getId() . '").val();'
                ...
                . 'requestAjax("","MET_VENDA_ExpItemSol","acaoExitCodigo","' . $oPrcBruto->getId() . ','
