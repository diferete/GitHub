...
class ViewMET_TEC_agendamentos extends View {
    ...
    public function criaConsulta() {
        ...
        $oNrFiltro = new Filtro($oNr, Filtro::CAMPO_TEXTO_IGUAL, 2, 2, 12, 12, false);
        $oTitFiltro = new Filtro($oTitulo, Filtro::CAMPO_TEXTO, 4, 4, 12, 12, false);
    ...
    public function criaTela() {
        ...
        $this->addCampos($oNr, $oLinha, $oTitulo, $oLinha, array($oClasse, $oMetodo), $oLinha, $oAgendamento, $oLinha, array($oData, $oHora, $oIntervalo), $oLinha, $oLinha2, $oLinha, $oParametros, $oLinha, $oObs, $oDiv1, $oDataUltResult, $oLog
        );
    }
