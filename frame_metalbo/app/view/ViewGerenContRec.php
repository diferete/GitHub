...
class ViewGerenContRec extends View {
    ...
    public function criaConsulta() {
        ...
        $oRecSit->addComparacao('Em aberto', CampoConsulta::COMPARACAO_IGUAL, CampoConsulta::COR_AZUL, CampoConsulta::MODO_COLUNA, false, null);
        $oRecSit->addComparacao('Pago', CampoConsulta::COMPARACAO_IGUAL, CampoConsulta::COR_VERDE, CampoConsulta::MODO_COLUNA, false, null);
        $oRecSit->setBComparacaoColuna(true);

        $this->setUsaDropdown(true);
        $oDrop1 = new Dropdown('Movimentações', Dropdown::TIPO_SUCESSO);
        $oDrop1->addItemDropdown($this->addIcone(Base::ICON_CONFIG) . 'Aponta pagamento', 'GerenContRec', 'acaoMostraTelaApontamentos', '', true, false, '', false, '', false, false);
        ...
        $oFiltroCli = new Filtro($oPerazao_nome, Campo::TIPO_TEXTO, 3, 3, 12, 12, false);
    ...
    public function criaTela() {
        ...
        $this->addCampos(array($oEmpCnpj, $oPescnpj, $oPesRazao), array($oRecDocto, $oRecParc, $oValor), $oRecvenc, $oRecObs, $oDataPag, $oSit, $oObsPag, $oUser);
    }
