...
class ViewTransp extends View {
    ...
    public function criaTela() {
        ...
        $oTabGeral->addCampos(array($oEmpCod, $oEmpdes, $oEmpCnpj), array($oEmpfant, $oEmpSit), $oEmpFone, array(/* $oEmailGeral, */$oEmpEnd, $oEmpBair, $oCidade, $oEmpEstCod), array($oCep, $oEmpIns), $oObs, array($oEmpUser, $oDataca), $oRepcod);
