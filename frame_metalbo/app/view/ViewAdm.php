...
class ViewAdm extends View {
    ...
    public function criaConsulta() {
        ...
        $oDataFiltro = new Filtro($oData, Filtro::CAMPO_DATA_ENTRE, 2, 2, 12, 12, false);
        ...
        $oDrop1->addItemDropdown($this->addIcone(Base::ICON_CONFIG) . 'Aponta pagamento', $this->getController(), 'getFaturamento', '', true, '', false, '', false, '', false, false);
