...
class ViewQualRncVenda extends View {
    ...
    public function criaConsulta() {
        ...
        $oDropDow->addItemDropdown($this->addIcone(Base::ICON_IMAGEM) . 'Visualizar', 'QualRncVenda', 'acaoMostraRelConsulta', '', false, 'rc');

        $oDropDow1 = new Dropdown('Devolução', Dropdown::TIPO_AVISO);
        $oDropDow1->addItemDropdown($this->addIcone(Base::ICON_CONFIRMAR) . 'Aceitar devolução', 'QualRncVenda', 'verifSitDevolucao', '', false, 'Aceitar');
        $oDropDow1->addItemDropdown($this->addIcone(Base::ICON_FECHAR) . 'Recusar devolução', 'QualRncVenda', 'verifSitDevolucao', '', false, 'Recusar');
    ...
    public function criaTela() {
        ...
        $oField->addCampos(array($oNr, $oFilcgc, $oUsunome, $oOfficeDes), 
                array($oRespVenda, $oRespVendaNome, $oDataIns, $oHora, $oSituaca, $oUsucodigo, $oOfficecod));
        ...
        $oDadosProduto->addCampos(array($oCodigo, $oProdes, $oQuant, $oAplicacao), 
                array($oQuanNconf, $oAceito, $oReprovar));
        ...
        $this->addCampos($oField, 
                array($oEmpcod, $oEmpdes), $oFieldContato, $oFieldNf, $oFieldEmb, $oDescNaoConf, $oDadosProduto, $oAnexos);
