...
class ViewMET_TabFrete extends View {
    ...
    public function criaTela() {
        ...
        $this->addCampos(array($oSeq, $oCnpj,$oEmpDes),$oL, 
                array($oCodtip, $oRef),$oL, 
                array($oTaxMin,$oTaxa,$oTaxa2),$oL, 
                array($oFreteValor, $oFretePeso, $oPedagio),$oL, 
                array($oTas, $oGris, $oImposto));
