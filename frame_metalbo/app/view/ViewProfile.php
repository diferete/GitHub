...
class ViewProfile extends View{
 ...
 public function criaTela() {
        ...
        $sCallback = 'if (requestJSON(true, "Profile", "validaLogin", $("#'.$this->getTela()->getId().'-form").serialize(), "'.$UsusenhaAtual->getNome().'").retorno == "true"){'
        ...
        $sAcaoAlterar ='requestAjax("'.$this->getTela()->getId().'-form","Profile","alteraSenha","'.$this->getTela()->getId().'-form");'; 
        ...
        $sAcaoAlterarImg ='requestAjax("'.$this->getTela()->getId().'-form","Profile","alteraImagem","'.$this->getTela()->getId().'-form");'; 
