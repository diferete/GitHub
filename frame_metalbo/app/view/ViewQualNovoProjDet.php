...
class ViewQualNovoProjDet extends View{
    ...
    public function criaTela() {
        ...
        $oFieldDetProj->addCampos(array($oLabel1,$oDesenPrev,$oDesenTer,$oDesenResp),$oLinha2,
                ...
                array($oLabel3,$oFerrPrev,$oFerrTer,$oFerrResp),$oLinha2,
                array($oLabel4,$oFerrDesenPrev,$oFerrDesenTer,$oFerrDesenResp),$oLinha2,
                array($oLabel5,$oFerrDistPrev,$oFerrDistTer,$oFerrDistResp),$oLinha2,
        ...
        $oDesenAcordo->addItenRadio('Nd', 'Não definido');
        
        $oComenCrit = new Campo('Comentários','comenCrit', Campo::TIPO_TEXTAREA,8);
        
        $oRespCrit = new Campo('Responsável','respAnaliseCri', Campo::TIPO_TEXTO,4);
        
        $oFieldCrit->setOculto(true);
        
        $oFieldCrit->addCampos(array($oFerrElaboradas,$oDesenAcordo),$oComenCrit,$oRespCrit);
