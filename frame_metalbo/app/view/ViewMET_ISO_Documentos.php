...
class ViewMET_ISO_Documentos extends View {
    ...
    public function criaConsulta() {
        ...
        $oDataRevisao = new CampoConsulta('Dt.Revisão', 'data_revisao', CampoConsulta::TIPO_DATA);
        ...
        $this->addCampos($oNr, $oFilcgc, $oNomeDoc, $oRevisao, $oDataRevisao, $oTotDig, $oTotFis);
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////        
        ...
        $oTabDigital->addCampos($oCopiasDigitais, array($oDig_Direcao, $oDig_Gestao_Qualidade, $oDig_Vendas, $oDig_Projetos), array($oDig_Plan_Producao, $oDig_Compras, $oDig_Almoxarifado, $oDig_Rh), array($oDig_Ti, $oDig_Expedicao, $oDig_Embalagem, $oDig_Seguranca), array($oDig_Garantia_Qualidade, $oDig_PCP, $oDig_Fosfatizacao, $oDig_Trefilacao), array($oDig_Conf_Frio_PO, $oDig_Conf_Frio_PA, $oDig_Machos, $oDig_Conf_Quente), array($oDig_Forno_Rev_Cont, $oDig_Galvanizacao, $oDig_Lab_Galvanizacao, $oDig_Usinagem), array($oDig_Expedicao_Expo, $oDig_Ferramentaria, $oDig_Manutencao, $oDig_Nylon), array($oDig_Ete, $oDig_Steeltrater, $oDig_Salt_Spray, $oDig_JL_Galvano), array($oDig_Prada_Galvano));
