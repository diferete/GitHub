...
if ($row['anexo1'] != '' && (strstr(strtolower($row['anexo1']), 'pdf'))) {
    ...
    if ($pdfversion > "1.4") {
        ...
        for ($i = 0; $i < $pageCount; $i++) {
            ...
            $pdf->Cell(26, 5, "ANEXO 1, Pg. " . $pg, 0, 1, 'L');
            $pg++;
        }
    } else {
...
if ($row['anexo2'] != '' && (strstr(strtolower($row['anexo2']), 'pdf'))) {
    ...
    if ($pdfversion > "1.4") {
        ...
        for ($i = 0; $i < $pageCount; $i++) {
            ...
            $pdf->addPage();
            $pdf->useImportedPage($tpl, null, null, null, null, true);
            $pdf->Cell(26, 5, "ANEXO 2, Pg. " . $pg, 0, 1, 'L');
            $pg++;
        }
    } else {
        $pageCount = $pdf->setSourceFile($OLD_PDF);
...
if ($row['anexo3'] != '' && (strstr(strtolower($row['anexo3']), 'pdf'))) {
    ...
    if ($pdfversion > "1.4") {
        ...
        for ($i = 0; $i < $pageCount; $i++) {
            ...
            $pdf->addPage();
            $pdf->useImportedPage($tpl, null, null, null, null, true);
            $pdf->Cell(26, 5, "ANEXO 3, Pg. " . $pg, 0, 1, 'L');
            $pg++;
        }
    } else {
        $pageCount = $pdf->setSourceFile($OLD_PDF);
...
//PARTE DOS ANEXOS xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
//ANEXO ANÁLISE 1
if ($row['anexo_analise'] != '' && (strstr(strtolower($row['anexo_analise']), 'png') || strstr(strtolower($row['anexo_analise']), 'jpg') || strstr(strtolower($row['anexo_analise']), 'jpeg'))) {
...
if ($row['anexo_analise'] != '' && (strstr(strtolower($row['anexo_analise']), 'pdf'))) {
    ...
    if ($pdfversion > "1.4") {
        ...
        for ($i = 0; $i < $pageCount; $i++) {
            ...
            $pdf->addPage();
            $pdf->useImportedPage($tpl, null, null, null, null, true);
            $pdf->Cell(26, 5, "ANEXO ANÁLISE 1, Pg. " . $pg, 0, 1, 'L');
            $pg++;
        }
    } else {
        $pageCount = $pdf->setSourceFile($OLD_PDF);
...
//ANEXO ANÁLISE 2
if ($row['anexo_analise1'] != '' && (strstr(strtolower($row['anexo_analise1']), 'png') || strstr(strtolower($row['anexo_analise1']), 'jpg') || strstr(strtolower($row['anexo_analise1']), 'jpeg'))) {
    if (isset($row['anexo_analise1'])) {
        $pdf->AddPage();
        $pdf->SetXY(10, 10);
        $sAnexoAnalise1 = $row['anexo_analise1'];
        $pdf->Cell(26, 5, "ANEXO ANÁLISE 2", 0, 1, 'L');
...
if ($row['anexo_analise1'] != '' && (strstr(strtolower($row['anexo_analise1']), 'pdf'))) {
    ...
    if ($pdfversion > "1.4") {
        ...
        for ($i = 0; $i < $pageCount; $i++) {
            ...
            $pdf->addPage();
            $pdf->useImportedPage($tpl, null, null, null, null, true);
            $pdf->Cell(26, 5, "ANEXO ANÁLISE 2, Pg. " . $pg, 0, 1, 'L');
            $pg++;
        }
    } else {
        $pageCount = $pdf->setSourceFile($OLD_PDF);
...
//PARTE DOS ANEXOS xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
//ANEXO INSPEÇÃO
if ($row['anexo_inspecao'] != '' && (strstr(strtolower($row['anexo_inspecao']), 'png') || strstr(strtolower($row['anexo_inspecao']), 'jpg') || strstr(strtolower($row['anexo_inspecao']), 'jpeg'))) {
...
if ($row['anexo_inspecao'] != '' && (strstr(strtolower($row['anexo_inspecao']), 'pdf'))) {
    ...
    if ($pdfversion > "1.4") {
        ...
        for ($i = 0; $i < $pageCount; $i++) {
            ...
            $pdf->addPage();
            $pdf->useImportedPage($tpl, null, null, null, null, true);
            $pdf->Cell(26, 5, "ANEXO INSPEÇÃO 1, Pg." . $pg, 0, 1, 'L');
            $pg++;
        }
    } else {
        $pageCount = $pdf->setSourceFile($OLD_PDF);
...
//ANEXO INSPEÇÃO 1
if ($row['anexo_inspecao1'] != '' && (strstr(strtolower($row['anexo_inspecao1']), 'png') || strstr(strtolower($row['anexo_inspecao1']), 'jpg') || strstr(strtolower($row['anexo_inspecao1']), 'jpeg'))) {
    if (isset($row['anexo_inspecao1'])) {
        $pdf->AddPage();
        $pdf->SetXY(10, 10);
        $sAnexoInspecao1 = $row['anexo_inspecao1'];
        $pdf->Cell(26, 5, "ANEXO INSPEÇÃO 2", 0, 1, 'L');
...
if ($row['anexo_inspecao1'] != '' && (strstr(strtolower($row['anexo_inspecao1']), 'pdf'))) {
    ...
    if ($pdfversion > "1.4") {
        ...
        for ($i = 0; $i < $pageCount; $i++) {
            ...
            $pdf->addPage();
            $pdf->useImportedPage($tpl, null, null, null, null, true);
            $pdf->Cell(26, 5, "ANEXO INSPEÇÃO 2, Pg." . $pg, 0, 1, 'L');
            $pg++;
        }
    } else {
        $pageCount = $pdf->setSourceFile($OLD_PDF);
