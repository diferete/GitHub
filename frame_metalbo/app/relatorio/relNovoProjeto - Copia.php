...
$pdf->Cell(199, 5, 'Total de projetos de Porcas cadastradas no período: ' . $iTotalPo['quantidade'], 0, 1, 'L');
$pdf->Cell(199, 5, 'Total de projetos de Parafusos cadastrados no período: ' . $iTotalPa['quantidade'], 0, 1, 'L');
