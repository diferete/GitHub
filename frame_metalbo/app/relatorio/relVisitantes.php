...
$pdf->Cell(50);
// Title
$pdf->Cell(95, 10, 'Relatorio de Visitantes', 0, 0, 'C');
...
$sSql = "select * from MET_PORT_Visitantes where datachegou BETWEEN '" . $data1 . "' and '" . $data2 . "'";
...
while ($row = $sth->fetch(PDO::FETCH_ASSOC)) {
    ...
    $pdf->SetFont('arial', '', 8);
    $pdf->Cell(20, 5, $row['cpf'], 'L,B,R,T', 0, 'L');
...
$pdf->SetFont('arial', 'B', 10);
$pdf->Cell(30, 5, 'Visita - 6000:', 0, 0, 'L');
$pdf->SetFont('arial', '', 10);
...
$pdf->Output('I', 'Rel.Visitantes' . $data1 . '.pdf');
