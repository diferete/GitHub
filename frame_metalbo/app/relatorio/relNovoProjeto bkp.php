...
$sql = "select nr,sitvendas,sitcliente,sitgeralproj,sitproj,procod,desc_novo_prod,repnome,resp_venda_nome,respvalproj, tbqualNovoProjeto.empcod,widl.EMP01.empdes,
...
$sqlTotalPa = "select count(tbqualNovoProjeto.procod) as quantidade from widl.PROD01
                 ...
                 where widl.PROD01.grucod = 13 and dtimp BETWEEN '" . $data1 . "' and '" . $data2 . "'";
$iTotalPa = $PDO->query($sqlTotalPa)->fetch(PDO::FETCH_ASSOC);
}
if ($sTipoProd == '' || $sTipoProd == '12') {
$sqlTotalPo = "select count(tbqualNovoProjeto.procod) as quantidade from widl.PROD01
                 left join tbqualNovoProjeto on tbqualNovoProjeto.procod = widl.PROD01.procod
                 where widl.PROD01.grucod = 12 and dtimp BETWEEN '" . $data1 . "' and '" . $data2 . "'";
