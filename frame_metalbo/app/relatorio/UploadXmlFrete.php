    ...
    if ($aRetorno == 1) {
        $sSql1 = " 
                ...
                select seq, ref, ROUND(
                    ...
                    where tbfrete.cnpj =" . $cnpj . " and SEQ not in(11,12,13,14,15,16)
                insert into tbnt2#
                select seq, ref, ROUND(
                    ...
                    from tbfrete left outer join tbnt#
                    on tbfrete.cnpj = tbnt#.cnpj
                    where tbfrete.cnpj =" . $cnpj . " and SEQ in(16)
                insert into tbnt2#
                select seq, ref, ROUND(
                    ROUND(ROUND( fretevalor * nfsvlrtot ,2) +ROUND( pesoNota * fretepeso,2) +ROUND( pedagio * FracaoFrete,2)+taxa2 +tas+(nfsvlrtot *gris)  ,2)/0.7875 ,2 )  as totalfrete,
                    ROUND(
                    ...
                    from tbfrete left outer join tbnt#
                    on tbfrete.cnpj = tbnt#.cnpj
                    where tbfrete.cnpj =" . $cnpj . " and SEQ in(11,13,14,15)
                insert into tbnt2#
                select seq, ref, ROUND(
                    ...
                    from tbfrete left outer join tbnt#
                    on tbfrete.cnpj = tbnt#.cnpj
                    where tbfrete.cnpj =" . $cnpj . " and SEQ in(12)";
