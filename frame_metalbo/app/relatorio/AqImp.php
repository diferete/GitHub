...
$sSql = "select causa,causades,causaprov,pq1,pq2,pq3,pq4,pq5 from tbacaoqualcausa where nr=" . $nrAq . " and filcgc ='" . $FilcgcRex . "' order by seq";
...
$sSql = "select plano,convert(varchar,dataprev,103) as dataprev,usunome,convert(varchar,datafim,103) as datafim,tbacaoqualplan.obsfim "
