...
$pdf->Cell(29, 5, "FILTROS:", 0, 0, 'L');

$pdf->SetFont('arial', 'B', 10);
$pdf->Cell(15, 5, "CNPJ: ", 0, 0, 'L');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(35, 5, $empcod, 0, 0, 'L');

$pdf->SetFont('arial', 'B', 10);
$pdf->Cell(20, 5, "Empresa:", 0, 0, 'L');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(70, 5, $empdes, 0, 0, 'L');
    ...
    if (isset($_REQUEST['atrasados'])) {
        if ($row['dias'] < 0) {
            if ($iEmp !== $row['empcod']) {
                ...
                $pdf->SetFont('Arial', '', 10);
                $pdf->Cell(120, 5, $row['empdes'], 0, 0, 'L');
            ...
            $pdf->Cell(53, 5, $row['NossoNumero'], 0, 0, 'L');
