...
class ControllerQualAqPlan extends Controller {

    public function __construct() {
        $this->carregaClassesMvc('QualAqPlan');
        $this->setControllerDetalhe('QualAqEficaz');
    ...
    public function apontaPlanoAcao($sDados) {
        ...
        if ($aCampos['datafim'] != null && $aCampos['obsfim'] != null) {
            ...
            if ($aRet[0]) {
                ...
                echo $sLimpa;
                echo 'requestAjax("' . $aDados[0] . '","QualAqPlan","getDadosGrid","' . $aDados[1] . '","criaConsutaApont");';
