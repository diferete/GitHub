...
class ControllerLogin extends Controller {
    ...
    function __construct() {
        $this->View = Fabrica::FabricarView('Login');
        $this->Model = Fabrica::FabricarModel('Login');
        $this->Persistencia = Fabrica::FabricarPersistencia('Login');
    ...
    public function logaSistema() {
        ...
        if ($aLogaSistema[0]) {
            ...
            $oControllerImagem = Fabrica::FabricarController('EmpImage');
