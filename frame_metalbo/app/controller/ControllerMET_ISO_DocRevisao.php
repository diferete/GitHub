...
class ControllerMET_ISO_DocRevisao extends Controller {

    public function __construct() {
        $this->carregaClassesMvc('MET_ISO_DocRevisao');
    }
    ...
    public function afterDelete() {
        ...
        $this->Persistencia->deletaDocumento($this->Model->getFilcgc(), $this->Model->getNr(), $this->Model->getSeq());
        $aRetorno[0] = true;
