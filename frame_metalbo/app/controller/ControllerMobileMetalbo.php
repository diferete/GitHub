...
class ControllerMobileMetalbo extends Controller{
    public function __construct() {
        $this->carregaClassesMvc('MobileMetalbo');
    }
    ...
    public function autenticaToken($UsuCodigo, $UsuToken){
        $oControllerLogin = Fabrica::FabricarController('Login');
       ...
       //verifica se o foi informado o código do usuário e um token
        if(empty($CampoUsuCod) || empty($CampoUsuToken)){
            ...
            if($Classe == 'Login' && $Metodo == 'validaMobLogin'){
                    ...
                    $oClasseLogin = Fabrica::FabricarController('Login');
        ...
        //se o token ou o código do usuário forem informado      
            ...
            if($Classe == 'Mobile' && ($Metodo == 'validaToken' || $Metodo == 'autenticaToken')){
