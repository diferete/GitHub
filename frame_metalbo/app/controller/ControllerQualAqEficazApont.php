...
class ControllerQualAqEficazApont extends Controller {

    public function __construct() {
        $this->carregaClassesMvc('QualAqEficazApont');
    }
    ...
    public function apontaEfi($sDados) {
        ...
        if ($aRet[0]) {
            ...
            echo $sLimpa;
            echo 'requestAjax("' . $aDados[0] . '","QualAqEficazApont","getDadosGrid","' . $aDados[1] . '","criaConsultaEf");';
        } else {
