...
class ControllerMET_ISO_RegistroTreinamento extends Controller {

    public function __construct() {
        $this->carregaClassesMvc('MET_ISO_RegistroTreinamento');
    }
    ...
    public function afterDelete() {
        ...
        $this->Persistencia->deletaRgistroTreinamento($this->Model->getFilcgc(), $this->Model->getNr(), $this->Model->getSeq());
        $aRetorno[0] = true;
