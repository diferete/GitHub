...
class ControllerMET_VENDA_ExpCot extends Controller {

    public function __construct() {
        $this->carregaClassesMvc('MET_VENDA_ExpCot');
        $this->setControllerDetalhe('MET_VENDA_ExpItemCot');
    ...
    public function getSget() {
        ...
        $oCotIten = Fabrica::FabricarPersistencia('MET_VENDA_ExpItemCot');
