...
class PersistenciaMET_TEC_Catalogo extends Persistencia {
    ...
    function buscaDadosFiltro($aDados) {
        $sSql = "select widl.prod01.procod,pdftabvendas.preco,prodes,pround,promatcod,ProClasseG,widl.prod05.media,metmat.material,"
                . "prodchamin,prodchamax,prodchamin,prodchamax,prodaltmin,prodaltmax,proddiamin,proddiamax,procommin,procommax,prodiapmin,"
                . "prodiapmax,prodiaemin,prodiaemax,procomrmin,procomrmax,comphastma,comphastmi,diamhastmi,diamhastma,pfcmin,pfcmax,proanghel "
                . "from widl.prod01 "
                . "left outer join pdftabvendas "
                . "on widl.prod01.procod = pdftabvendas.codigo "
                . "left outer join widl.prod05 "
                . "on widl.prod01.subcod = widl.prod05.subcod "
                . "left outer join metmat "
                . "on widl.prod01.procod = metmat.procod "
...
//====================================================================================================================//
        ...
        $sSql .= "and probloqpro <> 'S' and promatcod <> '' and pdftabvendas.preco is not null and "
                . "widl.prod01.subcod not in(2,9,116,128,201,202,203,204,205,206,207,208,209,210,211,212,213,214,215,216,217,218,219,220,221,222,223,224,225,226,260,329,700,710,711)";
