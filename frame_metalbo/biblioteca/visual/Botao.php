...
class Botao {
    ...
    function setDesativado($bValor){
        ...
        case self::TIPO_ADICIONAR:
           $sBotao = '<div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 btn-acao-grid">'
                     .'<button title="Adicionar registro" type="button" class="btn btn-success btn-sm margin-btn" name ="'.$this->getId().'"  id="'.$this->getId().'" '.  $this->setDesativado($this->getBDesativado()).'>'
         ...
         case self::TIPO_ALTERAR:
           $sBotao = '<div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 btn-acao-grid">'
                     .'<button  title="Alterar registro" class="btn btn-default btn-sm margin-btn" id="'.$this->getId().'" '.  $this->setDesativado($this->getBDesativado()).'>'
          ...
          case self::TIPO_REMOVER:
           $sBotao = '<div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 btn-acao-grid">'
                     .'<button  title="Remover registro" class="btn btn-danger btn-sm margin-btn" id="'.$this->getId().'"  '.  $this->setDesativado($this->getBDesativado()).' >'
       ...
       case self::TIPO_FILTRO:
        ...
        case self::TIPO_VIZUALIZAR:
            $sBotao = 
                '<div class="col-lg-1 col-md-1 col-sm-1 col-xs-2 btn-acao-grid">'
