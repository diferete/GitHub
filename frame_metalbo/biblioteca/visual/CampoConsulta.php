...
class CampoConsulta {
    ...
    //constantes responsáveis pelas cores simples
    const COR_DEFAULT = 'tr-default';
    ...
    //constantes responsáveis pelas cores no background
    const BK_VERMELHO = 'tr-bk-vermelha';
    const BK_AZUL = 'tr-bk-azul';
    const BK_AMARELO = 'tr-bk-amarelo';
    const BK_VERDE = 'tr-bk-verde';
    const BK_ROXO = 'tr-bk-roxo';
    const BK_ROSA = 'tr-bk-rosa';
    const BK_LARANJA = 'tr-bk-laranja';
     ...
     */
    public function addComparacao($sValor, $iTipoComp = self::COMPARACAO_IGUAL, $sCor = self::COR_VERMELHO, $iModo = self::MODO_LINHA) {
        $aComp['valor'] = $sValor;
    ...
    public function getRender($sClasse, $xValor) {
        switch ($this->Tipo) {
            ...
            case self::TIPO_DECIMAL:
                ...
                break;
            case self::TIPO_DATA:
                if (($xValor == '01/01/1970') || ($xValor == '31/12/1969')) {
                    $xValor = '';
