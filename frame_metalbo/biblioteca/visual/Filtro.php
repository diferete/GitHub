...
class Filtro {
     ...
     * @param type $sTelaGrande
     * @param type $sTelaMedia
     * @param type $sTelaPequena
     * @param type $sTelaMuitoPequena
     */
    public function __construct($oCampoConsulta, $iTipoCampo, $sTelaGrande = '2', $sTelaMedia = '2', $sTelaPequena = '2', $sTelaMuitoPequena = '12') {
        $this->Id = Base::getId();
    ...
    public function getRender() {
        switch ($this->iTipoCampo) {
            case self::CAMPO_TEXTO:
                ...
                /* '<div class="col-lg-'.$this->getSTelaGrande().' col-md-'.$this->getSTelaMedia().' col-sm-'.$this->getSTelaPequena().' col-xs-'.$this->getSTelaMuitoPequena().'">'
                  .'   <div class="form-group" id="'.$this->getId().'"> '
                  .'       <label for="inpt-name">'.$this->getSLabel().':</label>         '
                  .'       <input class="form-control input-sm" type="text" name="'.$this->getSNome().'" placeholder="Pesquisar..."> '
                  .'   </div> '
                  .'</div> '; */
            ...
            case self::CAMPO_INTEIRO:
                $sCampo = '<div class="campo-form col-lg-' . $this->getSTelaGrande() . ' col-md-' . $this->getSTelaMedia() . ' col-sm-' . $this->getSTelaPequena() . ' col-xs-' . $this->getSTelaMuitoPequena() . '" >'
                        //  .'<label for="input-texto">'.$this->getSLabel().':</label>' 
            ...
            case self::CAMPO_MONEY:
                $sCampo = '<div class="campo-form col-lg-' . $this->getSTelaGrande() . ' col-md-' . $this->getSTelaMedia() . ' col-sm-' . $this->getSTelaPequena() . ' col-xs-' . $this->getSTelaMuitoPequena() . '">'
                        //  .'<label for="input-money ">'.$this->getSLabel().':</label>'
