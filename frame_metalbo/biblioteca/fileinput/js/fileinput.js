...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            var self = this, tMain1, tMain2, tPreview, tFileIcon, tClose, tCaption, tBtnDefault, tBtnLink, tBtnBrowse,
                ...
                }, defBtnCss1 = 'btn btn-sm-fileinput btn-kv ' + $h.defaultButtonCss();
            tMain1 = '{preview}\n' +
            ...
            tActions = '<div class="file-actions">\n' +
                '    <div class="file-footer-buttons" style="display: inline-flex;">\n' +
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeErrorClass: 'btn btn-sm-fileinput btn-kv btn-danger',
    ...
    var IFRAME_ATTRIBS = 'class="kv-preview-data file-preview-pdf" src="{renderer}?file={data}" {style}',
        defBtnCss1 = 'btn btn-sm-fileinput btn-kv ' + $h.defaultButtonCss(), defBtnCss2 = 'btn ' + $h.defaultButtonCss(true);
