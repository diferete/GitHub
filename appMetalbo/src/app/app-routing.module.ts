...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./fat-metalbo-detalhe/fat-metalbo-detalhe.module').then(m => m.FatMetalboDetalhePageModule)
  },
  {
  ...
  },
  {
    ...
    loadChildren: () => import('./ped-metalbo-detalhe/ped-metalbo-detalhe.module').then(m => m.PedMetalboDetalhePageModule)
  },
  {
    path: 'prod-metalbo-detalhe',
    loadChildren: () => import('./prod-metalbo-detalhe/prod-metalbo-detalhe.module').then(m => m.ProdMetalboDetalhePageModule)
  },
  {
    path: 'prod-steel-detalhe',
    loadChildren: () => import('./prod-steel-detalhe/prod-steel-detalhe.module').then(m => m.ProdSteelDetalhePageModule)
  },
  {
    path: 'lista-fosfatizacao',
    loadChildren: () => import('./lista-fosfatizacao/lista-fosfatizacao.module').then(m => m.ListaFosfatizacaoPageModule)
  },
  {
    path: 'lista-fofatizacao-detalhe',
    loadChildren: () => import('./lista-fofatizacao-detalhe/lista-fofatizacao-detalhe.module').then(m => m.ListaFofatizacaoDetalhePageModule)
  },
  {
    path: 'walkthrough',
