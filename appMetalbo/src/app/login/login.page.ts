...
export class LoginPage implements OnInit {
  ...
  doLogin(): void {
    ...
    this.conexao
      .logaApp(this.usuario, this.senha)
      .then((result: any) => {
        if (result.SUCESSO) {
          this.mensagemLogado();
          this.gravaDadosUsuario(
            result.DADOS.usucodigo,
            result.DADOS.usunome,
            result.DADOS.usulogin,
            result.DADOS.codsetor,
            result.TOKEN,
            result.DADOS.usulogin
          );
  ...
  doValidaToken() {
    ...
    this.StorageServ.retornaToken().then((result: any) => {
      ...
      this.StorageServ.retornaUsuCod().then((result: any) => {
        ...
        this.conexao.validaToken(usucod, usutoken).then((result: any) => {
