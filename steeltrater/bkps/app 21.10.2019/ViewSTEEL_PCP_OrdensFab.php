...
class ViewSTEEL_PCP_OrdensFab extends View{
    ...
    public function criaTela() {
      ...
      //  $oProdFinalDes->setBCampoBloqueado(true);
        ...
        //evento para bloquear ou desbloquear campo
         $sEventoSelect = '$("#'.$oTipo->getId().'").each(function() { '
                         .'if($(this).val()!=="A"){ '
                         .'console.log("entrou na condição");'
                         .'mensagemSlide("warning", "Não é necessário informar produto final se OP não for do tipo Arame.","Atenção!");'
                         .'$("#'.$oProdFinal->getId().'").val("");'
                         .'$("#'.$oProdFinalDes->getId().'").val("");'
                         . ' } '
                         . '});';
        $oProdFinal->addEvento(Campo::EVENTO_FOCUS ,$sEventoSelect);
