...
problema,solucao,situaca,mecanico,consumo,userenc,convert(varchar,dataenc,103)as dataenc,horaenc,convert(varchar,previsao,103)as previsao,
solucao,consumo
...
$pdf->SetFont('arial','B',12);
$pdf->Cell(60,20,"Solução",0,1,'L');
$pdf->Cell(0,5,"","B",1,'C');
$pdf->Ln(5);
$pdf->setFont('arial','',9);
//$pdf->SetXY(61,92);
$pdf->MultiCell(600, 15,$solucao,0,'J');
$pdf->Ln(20);

$pdf->SetFont('arial','B',12);
$pdf->Cell(60,20,"Consumo",0,1,'L');
$pdf->Cell(0,5,"","B",1,'C');
$pdf->Ln(5);
$pdf->setFont('arial','',9);
//$pdf->SetXY(61,92);
$pdf->MultiCell(600, 15,$consumo,0,'J');

$pdf->Cell(60,20,"",0,1,'L');
$pdf->Cell(0,5,"","B",1,'C');

$pdf->SetFont('arial','B',12);
$pdf->Cell(90,20,"Encerramento:",0,0,'L');
$pdf->setFont('arial','',12);
$pdf->Cell(120,20,$dataenc,0,0,'L');

$pdf->SetFont('arial','B',12);
$pdf->Cell(40,20,"Hora:",0,0,'L');
$pdf->setFont('arial','',12);
$pdf->Cell(60,20,$hora,0,1,'L');

$pdf->SetFont('arial','B',12);
$pdf->Cell(60,20,"Usuário:",0,0,'L');
$pdf->setFont('arial','',12);
$pdf->Cell(120,20,$userenc,0,1,'L');

$pdf->Ln(15);
$pdf->Cell(0,5,"","B",1,'C');
$pdf->Cell(60,20,"Assinatura",0,1,'L');
$pdf->Cell(0,5,"","B",1,'C');
