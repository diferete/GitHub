...
class ControllerMET_QUAL_AqPlanApont extends Controller {

    public function __construct() {
        $this->carregaClassesMvc('MET_QUAL_AqPlanApont');
    }
    ...
    public function apontaPlanoAcao($sDados) {
        ...
        if ($aRet[0]) {
            ...
            echo $sLimpa;
            echo 'requestAjax("' . $aDados[0] . '","MET_QUAL_AqPlanApont","getDadosGrid","' . $aDados[1] . '","criaConsutaApont");';
