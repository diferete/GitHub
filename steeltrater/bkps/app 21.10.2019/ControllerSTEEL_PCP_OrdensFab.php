   ...
   */
    ...
    public function verificaOp(){
        if($this->Model->getTipoOrdem()=='A'){
            ...
            $svlr = $this->Model->getProdFinal();
            if(($this->Model->getProdFinal()!=='')){
                $oModal = new Modal('Atenção!','Não é necessário informar um produto final para este tipo de OP.', Modal::TIPO_AVISO, false, true);
                echo $oModal->getRender();
                exit();
            }
        }
