...
class ViewSTEEL_PCP_prodMatReceita extends View {
    ...
    public function criaTela() {
        ...
        //field dados fio máquina
        $oField1 = new FieldSet('FIO MÁQUINA');
        ...
        $oField1->addCampos(array($oFioDurezaSol,$oFioEsferio),array($oFioDescarbonetaTotal,$oFioDescarbonetaParcial),array($oDiamFinalMin,$oDiamFinalMax));
   
        
        $this->addCampos($oSeqMat, array($oCodigo,$oProdes),array($oMatCod, $oMatdes),
                array($oRecCod, $oRecdes), 
                $oLabel1,array($oNucDurMin,$oNucDurMax,$oNucEscala),
                array($oSupDurMin,$oSupDurMax,$oSupEscala), 
                array($oCamDurMin,$oCamDurMax),$oTratReven,$oField1);
    }
