...
class ViewDELX_PRO_ProdutoFilial extends View {
    ...
    public function criaTela() {
       ...
       // $sTituloD->setApenasTela(true); 
        ...
        $sTituloC->addCampos(array($oPlan,$oTipOrd),array($oDcomp,$oDprod,$oDqntd,$oDforn),$oB,
                array($oTipEstMin,$oPerEstMin,$oQntLotMin,$oQntLotMul),$oB,
                array($oDiasAgrup,$oQntLotPro, $oAcaoMrp,$oFilialPro));
        ...
        $oAbaGeral->addCampos(array($oProduto,$oProdutoDes),$oFantasia,$oL,$sTituloA,
                array($oGrupo,$oSubGrupo,$oFamilia,$oSubFamilia),$oB,
                array($oTipoGrupo,$oDataBloqueio,$oMotivoBloqueio),$oB,
                array($oItemMovEst,$oPermEstNeg,$oEstMin,$oDiasEstMin, $oPontRepos,$oEstMax, $oDiasEstMax),$oB,
                array($oDataUltInvRot, $oProdutoComp,$oTipoContFat,$oResEstEstPedid,$oQntMultPad,$oProdututividade,$oProContVeiculo),
                $oB,$sTituloB,
                $oB,$sTituloC,
                $oB,$sTituloD,
                $oB,$sTituloE,
        ...
        $oTab->addItems($oAbaGeral, $oAbaAlmox,$oAbaDespe,$oAbaForne,
                $oAbaClien,$oAbaEstGrad,$oAbaFecEst,$oAbaBloqMod);
