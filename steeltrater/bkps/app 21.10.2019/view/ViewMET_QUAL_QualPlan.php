...
class ViewMET_QUAL_QualPlan extends View{
    ...
    public function addeventoConc() {
        ...
        $aValor = $this->getAParametrosExtras();
        $sRequest = 'requestAjax("","MET_QUAL_QualPlan","geraRelPdfAq","'. $aValor[0].','.$aValor[1].',AqImp");';
        $sRequest .='requestAjax("","MET_QUAL_QualAq","envMailMsg","'. $aValor[0].','.$aValor[1].',AqImp");';
