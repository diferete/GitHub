      ...
      /*traz a versão do sistema*/
        ...
        .'<script src="biblioteca/assets/vendor/summernote/lang/summernote-pt-BR.js"></script>'
         ...
         // .'      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">'
          .'     <a href="https://sistema.metalbo.com.br/" target="_blank" rel="noopener"> <img class="navbar-brand-logo" style ="margin-top:10px; margin-left:10px" id="logo" src="Uploads/'.$_SESSION['imgLogo'].'" title="Metalbo"> </a>'
   ...
   */
    ...
    public function montMsgInicial(){
        $sMsg = '<div class="example-wrap" id="perfilPrincipal">'
         ...
         .'   <a id="link_delx" target="_blank" href="http://177.84.0.34:8080/DelsoftXPRO/servlet/loginerp">DelsoftX</br> '
