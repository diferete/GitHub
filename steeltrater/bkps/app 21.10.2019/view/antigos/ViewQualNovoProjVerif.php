    ...
    public function criaTela() {
       ...
       $oFiedVerif->setOculto(true);
        ...
        $oFiedVerif->addCampos($oLinhaBranco,array($oLabel1,$oVerifDesenPrev,$oVerifDesenTer,
            $oVerifDesenResp,$oVerifDesenAnx),$oLinha1,
                array($oLabel2,$oVerifRelFerrPrev,$oVerifRelFerrTer,$oVerifRelFerrResp,$oVerifRelFerrAnx),$oLinha1,
                array($oLabel3,$oVerifDesenFerrPrev,$oVerifDesenFerrTer,$oVerifDesenFerrResp,$oVerifDesenFerrAnx),$oLinha1,
                //array($oLabel4,$oDimenFerrPrev,$oDimenFerrTer,$oDimenFerrResp,$oDimenFerrAnex),$oLinha1,
                array($oLabel5,$oDimenProdPrev,$oDimenProdTer,$oDimenProdResp,$oDimenProdAnex),$oLinha1,
                array($oLabel6,$oCamadaZincoPrev,$oCamadaZincoTer,$oCamadaZincoResp,$oCamadaZincoAnex),$oLinha1,
                array($oLabel7,$oEnsaioDurezaPrev,$oEnsaioDurezaTer,$oEnsaioDurezaResp,$oEnsaioDurezaAnex),$oLinha1,
                array($oLabel8,$oCargaprovaPrev,$oCargaprovaTer,$oCargaprovaResp,$oCargaprovaAnex),$oLinha1,
                array($oLabel9,$oTerceiroPrev,$oTerceiroTer,$oTerceiroResp,$oTerceiroAnex));
        ...
        $oFieldValProjeto->addCampos(array($oValNf,$oValNfPrev,$oValNfTer,$oValNfResp),
                array($oValOd,$oValOdPrev,$oValOdTer,$oValOdResp),array($oValPed,$oValPedPrev,$oValPedTer,$oValPedResp),
                array($oValPapp,$oValPappPrev,$oValPappTer,$oValPappResp));
        ...
        $oComenValProj = new Campo('Comentários / Alterações Propostas','comenvalproj', Campo::TIPO_TEXTAREA,8);
        $oRespVal = new campo('Responsável','respvalproj', Campo::TIPO_TEXTO,3);
