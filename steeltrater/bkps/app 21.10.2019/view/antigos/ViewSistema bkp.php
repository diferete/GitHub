    ...
    function constroiTelaInicial(){
      //verifica se há representantes atrelados
        ...
        .'<script src="biblioteca/assets/vendor/summernote/lang/summernote-pt-BR.js"></script>'
         ...
         // .'      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">'
          .'        <img class="navbar-brand-logo" style ="margin-top:10px; margin-left:10px" id="logo" src="Uploads/'.$_SESSION['imgLogo'].'" title="Metalbo">'
       ...
       /*   .'      <button type="button" class="navbar-toggle collapsed" data-target="#site-navbar-search"'
          ...
          .'  data-animation="fade" role="button"><i class="icon fa-stack-overflow" aria-hidden="true"></i> Módulos</a>'
      ...
      /*    .'              <li role="presentation">'
        ...
        //  .'                          <h6 class="media-heading">Código: '.$_SESSION['codUser'].'</h6>'
          ...
          .'            <ul class="dropdown-menu" role="menu">'
          .'              <li role="presentation">'
          .'                <a href="javascript:void(0)" role="menuitem" onclick="verificaTab(\'menu-1-p\',\'1-p\',\'Profile\',\'acaoMostraTelaAlterar\',\'usucodigo='.$_SESSION["codUser"].',tabmenu-1-pcontrol\',\'Meu Perfil\');"><i class="icon wb-user" aria-hidden="true"></i> Perfil</a>'
          .'              </li>'
         /* .'              <li role="presentation">'
