...
class ViewQualRncVenda extends View{
     public function criaConsulta() {
        ...
        $oDropDow = new Dropdown('Imprimir', Dropdown::TIPO_PRIMARY);
        ...
        $oDropDow1->addItemDropdown($this->addIcone(Base::ICON_CONFIRMAR).'Finalizar','QualRncVenda','criaTelaModalFinaliza','', false, '',false,'criaTelaModalFinaliza',true,'Finalizar Reclamação');
    ...
    public function criaTela() {
        ...
        $oPedido = new campo('Pedido','pedido', Campo::TIPO_TEXTO,1);
