...
(function (factory) {
    ...
    defaultFileActionSettings = {
        removeIcon: '<i class="icon wb-trash text-danger"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="icon wb-upload text-info"></i>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        indicatorNew: '<i class="icon wb-hand-down text-warning"></i>',
        indicatorSuccess: '<i class="icon wb-ok-sign text-success"></i>',
        indicatorError: '<i class="icon wb-exclamation-sign text-danger"></i>',
        indicatorLoading: '<i class="icon wb-hand-up text-muted"></i>',
    ...
    tIcon = '<span class="icon wb-file kv-caption-icon"></span>';
    ...
    $.fn.fileinput.defaults = {
        ...
        previewFileIcon: '<i class="icon wb-file"></i>',
        ...
        cancelIcon: '<i class="icon wb-ban-circle"></i>',
        cancelClass: 'btn btn-default',
        uploadIcon: '<i class="icon wb-upload"></i>',
        ...
        msgValidationErrorIcon: '<i class="icon wb-exclamation-sign"></i> ',
        ...
        zoomIndicator: '<i class="icon wb-zoom-in"></i>',
