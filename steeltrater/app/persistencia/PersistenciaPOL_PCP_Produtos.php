...
/*
 * Classe que implementa a persistencia de POL_PCP_Produtos 
 * 
 * @author Cleverton Hoffmann
 * @since 15/02/2021
 */

class PersistenciaPOL_PCP_Produtos  extends Persistencia {
    ...
    public function __construct() {
        ...
        $sAndFilial = ' and "STEEL_PCP_ProdutoFilial".fil_codigo = 83781641000158 ';
        $this->adicionaJoin('STEEL_PCP_ProdutoFilial', null, 1, 'pro_codigo', 'pro_codigo', $sAndFilial);
        
       // $this->adicionaFiltro('fil_codigo', '83781641000158');
    ...
    public function geraSequencia() {
        $sSql = "select max(pro_codigo)+1 as seq from pro_produto where pro_codigo >= 77770001 and pro_codigo < 80000000";
