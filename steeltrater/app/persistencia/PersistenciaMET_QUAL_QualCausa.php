...
class PersistenciaMET_QUAL_QualCausa extends Persistencia{
    public function __construct() {
        parent::__construct();
        
        $this->setTabela('MET_QUAL_qualcausa');
    ...
    public function atualizaOcorrencia($sFilcgc,$sNr,$sSeq){
        $sSql="select * from MET_QUAL_qualcausa where filcgc = '".$sFilcgc."' and nr ='".$sNr."'";
        ...
        while( $oRow = $result->fetch(PDO::FETCH_OBJ) ) {
            ...
            $sSql2="select COUNT(*)as ocorrencia from MET_QUAL_qualcausa 
            ...
            //gera o update
            $sSql3 ="update MET_QUAL_qualcausa set ocorrencia ='".$sOcorrencia."' 
                    where filcgc ='".$sFilcgc."' and nr ='".$sNr."'
                    and causa ='".$sCausa."'";
