...
/*
 * Implementa a classe persistencia MET_MANUT_OSPesqProd
 * @author Cleverton Hoffmann
 * @since 27/09/2021
 */

class PersistenciaMET_MANUT_OSPesqProd extends Persistencia {
    ...
    public function __construct() {
        ...
        $this->adicionaFiltro('pro_grupocodigo', $aGrupDados, Persistencia::LIGACAO_AND, Persistencia::GRUPO);
