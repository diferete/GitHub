...
//        $otipmanut = new CampoConsulta('tipmanut', 'tipmanut', CampoConsulta::TIPO_TEXTO);
    ...
    public function criaTela() { 
        ...
        $oCCT_CentroCusto = new Campo('Centro de Custo', 'cct_codigo', Campo::TIPO_BUSCADOBANCOPK, 2, 2, 12, 12);
        $oCCT_CentroCusto->addValidacao(false, Validacao::TIPO_STRING, 'Campo não pode estar em branco!', '0');

        $oCCT_Descricao = new Campo('Descrição', 'STEEL_CCT_CentroCusto.cct_descricao', Campo::TIPO_BUSCADOBANCO, 3, 3, 12, 12);
...
//        $otipmanut = new Campo('tipmanut', 'tipmanut', Campo::TIPO_TEXTO, 1, 1, 12, 12);
        ...
        $oAbaCadastro->addCampos(array($ofil_codigo, $ofil_Des), $oLinha1, array($ocod, $ocodigoMaq, $omaquina), $oLinha1, array($oseq, $omaqtip, $oCCT_CentroCusto, $oCCT_Descricao), $oLinha1, $oObs);
