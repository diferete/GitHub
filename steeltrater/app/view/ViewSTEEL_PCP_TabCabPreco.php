...
class ViewSTEEL_PCP_TabCabPreco extends View {
    ...
    public function criaConsulta() {
        ...
        $oDrop1->addItemDropdown($this->addIcone(Base::ICON_IMAGEM) . 'Visualizar', 'STEEL_PCP_TabCabPreco', 'acaoMostraRelConsulta', '', false, 'RelTabelaPreco');
    ...
    public function criaTela() {
        ...
        if($sAcao=='acaoAlterar'){$oEmp_codigo->setBCampoBloqueado(true);}
        ...
        if($sAcao=='acaoAlterar'){$oEmp_des->setBCampoBloqueado(true);}
