...
//verifica se há representantes atrelados
        ...
        $sTela = '<!DOCTYPE html>'
                ...
                . '<img class="navbar-brand-logo" style ="margin-top:10px; margin-left:10px" id="logo" src="Uploads/' . $_SESSION['imgLogo'] . '" title="Steeltrater"> </a>'
    ...
    public function montMsgInicial() {
        $sMsg = '<div class="example-wrap" id="perfilPrincipal">'
                ...
                . '<a style="color:blue" target="_blank" href="http://www.metalbo.com.br/steeltrater">www.metalbo.com.br/steeltrater</a></br> '
                . '<a style="color:blue" id="link_delx" target="_blank" href="http://177.84.0.34:8080/DelsoftXPRO/servlet/loginerp">DelsoftX</br> '
