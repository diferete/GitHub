...
//verifica se há representantes atrelados
        ...
        $sTela = '<!DOCTYPE html>'
                ...
                . '<button type="button" class="navbar-toggle hamburger hamburger-arrow-left navbar-toggle-left hided "'
                . 'data-toggle="menubar">'
                ...
                . '</ul>'
                . '<li class="dropdown dropdown-fw dropdown-mega"> '
                . '<a href="http://177.84.0.34:8080/DelsoftX/servlet/loginerp?" target="_blank" >'
                //. '<i class="icon wb-calendar" ></i>'
                . '<img style="width:51%;" src="biblioteca/assets/images/delsoft2.png" aria-hidden="true"/>'
                //. '<i class="icon wb-users" aria-hidden="true"></i>&nbspNfe/ Fiscal/ Contábil</a>'
                . '</li>'
                . '<!--fim acesso modulos-->'
                . '</ul>'
                . '</li>'
                ...
                . '<ul class="dropdown-menu" role="menu">'
                . '<li role="presentation">'
                . '<a href="javascript:void(0)" role="menuitem" onclick="verificaTab(\'menu-1-p\',\'1-p\',\'MET_TEC_Profile\',\'acaoMostraTelaPerfil\',\'usucodigo=' . $_SESSION["codUser"] . ',tabmenu-1-pcontrol\',\'Meu Perfil\');"><i class="icon wb-user" aria-hidden="true"></i> Perfil</a>'
                . '</li>'
        ...
        $sTela = $sTela . '</div>'
                ...
                . '<!-- Selectable -->'
                . '<script src="biblioteca/assets/js/components/selectable.js"></script>'
                . '<script src="biblioteca/assets/js/plugins/selectable.js"></script>'
                . '<!-- Scripts -->'
    ...
    public function montaModulo() {
        $oModuloUsuario = Fabrica::FabricarController('MET_TEC_ModUsuario');
    ...
    public function favMenu() {
        $oFavMenu = Fabrica::FabricarController('MET_TEC_FavMenu');
    ...
    public function montaTabela() {
        ...
        foreach ($aBuscaUpdates as $key => $value) {
            ...
            if ($value->anexo != '') {
                $html = $html . ' <td><a href = "https:sistema.metalbo.com.br/steeltrater/uploads/' . $value->anexo . '" target = "_blank" rel = ”noopener”>Clique aqui</a></td> ';
            } else {
                $html = $html . ' <td></td> ';
            }
            $html = $html . ' </tr> ';
