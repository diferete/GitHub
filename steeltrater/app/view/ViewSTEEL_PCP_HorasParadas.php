...
class ViewSTEEL_PCP_HorasParadas extends View {
    ...
    public function criaTela() {
        ...
        if ($sAcaoRotina == 'acaoVisualizar') {
            $this->addCampos(array($oSeq, $oForno, $oFornoDes, $oUsuNome), $oDivisor, array($oDataIni, $oHoraIni), $oDivisor1, array($oDataFim, $oHoraFim), $oCodMotivo);
        } else {
        $this->addCampos(array($oSeq, $oForno, $oFornoDes, $oUsuNome), $oDivisor, array($oDataIni, $oHoraIni), $oDivisor1, array($oDataFim, $oHoraFim), $oCodMotivo, $oBtnConf);
    }
