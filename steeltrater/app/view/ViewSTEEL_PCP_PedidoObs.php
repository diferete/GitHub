...
class ViewSTEEL_PCP_PedidoObs extends View {
    ...
    public function criaConsulta() {
        ...
        $oDescricaofiltro = new Filtro($oObserv, Filtro::CAMPO_TEXTO, 5, 5, 12, 12, false);
        $oCodigofiltro = new Filtro($oCodPed, Filtro::CAMPO_TEXTO_IGUAL, 2, 2, 12, 12, false);
        $oPedidofiltro = new Filtro($oPedFil, Filtro::CAMPO_TEXTO_IGUAL, 2, 2, 12, 12, false);
