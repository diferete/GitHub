...
class ViewSTEEL_PCP_fornoProd extends View {
    ...
    public function criaConsulta() {
        ...
        $oProdFiltro = new Filtro($oProd, Filtro::CAMPO_TEXTO_IGUAL, 2, 2, 12, 12, false);
        $oFornoCodFiltro = new Filtro($oFornoCod, Filtro::CAMPO_TEXTO_IGUAL, 2, 2, 12, 12, false);
        $oFornoDesFiltro = new Filtro($oFornoDes, Filtro::CAMPO_TEXTO_IGUAL, 2, 2, 12, 12, false);
