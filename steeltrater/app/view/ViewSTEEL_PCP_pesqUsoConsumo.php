...
class ViewSTEEL_PCP_pesqUsoConsumo extends View {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $oGrupoDes->setSValor('USO E CONSUMO STEEL');
        ...
        $oSubGrupoDes = new Campo('Descrição', 'DELX_PRO_Subgrupo.pro_subgrupodescricao', Campo::TIPO_BUSCADOBANCO, 6, 6, 12, 12);
        ...
        $oSubFamiliaDes->setSValor('GERAL');
