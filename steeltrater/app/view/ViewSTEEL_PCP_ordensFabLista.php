...
class ViewSTEEL_PCP_ordensFabLista extends View {
    ...
    public function criaConsulta() {
        ...
        $oProdFiltro = new Filtro($oProduto, Filtro::CAMPO_TEXTO_IGUAL, 2);

        $oCliFiltro = new Filtro($oCliente, Filtro::CAMPO_TEXTO, 3);

        $oFornoFiltro = new Filtro($oForDes, Filtro::CAMPO_SELECT, 3, 3, 3, 3);
