...
class ViewSTEEL_PCP_PedCarga extends View {
    ...
    public function criaTela() {
        ...
        $this->addCampos(
                array($oFilial, $oUseEmiss, $oDataEmiss, $oDataDig, $oNrCarga, $oPedSit, $oPedAprov), $oLabel, $oLabel, array($oOpBase, $oEmp_codigo, $oEmp_des), $oLabel, array($oMovCod, $oMov_des), $oLabel, array($oTabPreco, $oTabPrecoDesc, $oDataEnt, $oMarca), $oLabel, array($oFrete, $oEspecie, $oPesoBruto, $oPesoLiquido), $oAcao
        );
    }
