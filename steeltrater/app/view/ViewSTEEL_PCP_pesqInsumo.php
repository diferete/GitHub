...
class ViewSTEEL_PCP_pesqInsumo extends View {
    ...
    public function criaConsulta() {
        ...
        $oFiltroReferencia = new Filtro($oRefCliente, Filtro::CAMPO_TEXTO_IGUAL, 2, 2, 12, 12, false);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $oGrupoDes->setSValor('STEELTRATER INSUMOS');
        ...
        $oSubGrupoDes = new Campo('Descrição.........*Confira se o subgrupo se enquadra no tipo de insumo', 'DELX_PRO_Subgrupo.pro_subgrupodescricao', Campo::TIPO_BUSCADOBANCO, 6, 6, 12, 12);
        ...
        $oSubGrupoDes->setSValor('INSUMOS PARAF. METALBO');
        ...
        $oSubFamiliaDes->setSValor('INSUMOS');
        ...
        $oUnidadeMedDes->setSValor('Unidade');
