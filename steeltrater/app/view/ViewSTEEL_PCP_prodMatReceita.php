...
class ViewSTEEL_PCP_prodMatReceita extends View {
    ...
    public function criaConsulta() {
        ...
        $oFilProdCod = new Filtro($oProCod, Filtro::CAMPO_TEXTO, 3, 3, 12, 12, false);
        $oFilSeqMat = new Filtro($oSeqMat, Filtro::CAMPO_TEXTO, 3, 3, 12, 12, false);
        $oFilProdFinal = new Filtro($oProdFinal, Filtro::CAMPO_TEXTO, 3, 3, 12, 12, false);

        $oFilDesativa = new Filtro($oDesativa, Filtro::CAMPO_SELECT, 3, 3, 12, 12, false);
