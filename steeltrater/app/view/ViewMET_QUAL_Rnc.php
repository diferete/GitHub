...
class ViewMET_QUAL_Rnc extends View {
    ...
    public function criaConsulta() {
        ...
        $oFiloDatabert = new Filtro($oDatabert, Filtro::CAMPO_DATA_ENTRE, 1, 1, 12, 12, false);


        $this->addFiltro($oFiltroNr, $oFilCodProd, $oFilCodProbl, $oFilFornecedor, $oFiltroDescP, $oFilCausadores, $oFiloDatabert);
