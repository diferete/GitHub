...
class ViewSTEEL_PCP_OrdensFabItens extends View {
    ...
    public function gridApontaEtapa() {
        ...
        $oGridEtapa->addCampos($oBotaoStart, $oBotaoFinalizar, $oBotaoRetornar, $oOpGrid, $oReceitaSeq, $oTratamento, $oSituacaoConsulta, $oFornodesConsulta, $oTurnoEntrada, $oDataEntConsulta, $oHoraEntConsulta, $oUserEntConsulta, $oTurnoSaida, $oDataSaidaConsulta, $oHoraSaidaConsulta, $oUserSaidaConsulta, $oDiamMin, $oDiamMax);
    ...
    public function gridApontaEtapaGeren() {
        ...
        $oGridEtapa->addCampos($oBotaoStart, $oBotaoFinalizar, $oBotaoRetornar, $oOpGrid, $oReceitaSeq, $oTratamento, $oSituacaoConsulta, $oFornodesConsulta, $oDataEntConsulta, $oHoraEntConsulta, $oUserEntConsulta, $oDataSaidaConsulta, $oHoraSaidaConsulta, $oUserSaidaConsulta);
