...
class ViewSTEEL_PCP_ServicoEquip extends View {
    ...
    public function criaConsulta() {
        ...
        $oFiltroTrat = new Filtro($oTratDes, Filtro::CAMPO_TEXTO, 4, 4, 12, 12, false);
    ...
    public function criaTela() {
        ...
        $oTratCod = new Campo('Serviço', 'tratcod', Campo::TIPO_BUSCADOBANCOPK, 2, 2, 12, 12);
        ...
        $oFornoCod = new Campo('Código do forno', 'fornocod', Campo::TIPO_BUSCADOBANCOPK, 2, 2, 12, 12);
