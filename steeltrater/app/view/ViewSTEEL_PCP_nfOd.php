...
class ViewSTEEL_PCP_nfOd extends View{
    public function criaTela() {
       ...
       // $this->setBTela(false);
        ...
        $this->addCampos(array($oOd,$oOdEmp),
                $oLinha,array($oNf,$oNfEmp),$oLinha,$oBtnInserir);
    ...
    public function criaConsulta() {
     ...
     //   $oOpAntesFiltro = new Filtro($oOpAntes, Filtro::CAMPO_TEXTO_IGUAL, 2);
        ...
        $this->addCampos($oDocumento,$oXPed,$oOp, $oBotaoModal, $oBotaoFat, $oSituacao, 
                $oNrCarga, $Pendencia, $oData, $oCodigo, $oReferencia, 
                $oProdes, $oPeso, $oRetrabalho,$oReceita, $oTipOrdem);
