...
class ViewSTEEL_PCP_OrdensFabApontLista extends View {
    ...
    public function criaConsulta() {
        ...
        $oRefFiltro = new Filtro($oRefencia, Filtro::CAMPO_TEXTO_IGUAL, 2, 2, 12, 12, false);
        ...
        $oClienteFiltro = new Filtro($oCliente, Filtro::CAMPO_TEXTO, 5, 5, 12, 12, false);



        //filtro de situacao
        $oSitFiltro = new Filtro($oSituacao, Filtro::CAMPO_SELECT, 2, 2, 12, 12, false);
        ...
        //situação da lista
        $oSitListaFiltro = new Filtro($oSitLista, Filtro::CAMPO_SELECT, 3, 3, 12, 12, false);
        ...
        $oDataFiltro = new Filtro($oData, Filtro::CAMPO_DATA_ENTRE, 2, 2, 12, 12, true);
