...
class ViewSTEEL_PCP_OrdensFabApontLista extends View{
    ...
    public function criaConsulta() {
        ...
        $oRetrabalho = new CampoConsulta('Retrab.', 'retrabalho', CampoConsulta::TIPO_TEXTO);
        $oRetrabalho->addComparacao('Não', CampoConsulta::COMPARACAO_IGUAL, CampoConsulta::COL_PADRAO,CampoConsulta::MODO_COLUNA, false, '');
        $oRetrabalho->addComparacao('Sim', CampoConsulta::COMPARACAO_IGUAL, CampoConsulta::COL_VDCLARO,CampoConsulta::MODO_COLUNA, false, '');
        $oRetrabalho->addComparacao('Sim S/Cobrança', CampoConsulta::COMPARACAO_IGUAL, CampoConsulta::COL_VDCLARO,CampoConsulta::MODO_COLUNA, false, '');
        $oRetrabalho->addComparacao('Retorno não Ind.', CampoConsulta::COMPARACAO_IGUAL, CampoConsulta::COL_PADRAO,CampoConsulta::MODO_COLUNA, false, '');
        $oRetrabalho->addComparacao('OP origem retrabalho', CampoConsulta::COMPARACAO_IGUAL, CampoConsulta::COL_PADRAO,CampoConsulta::MODO_COLUNA, false, '');
        //$oRetrabalho->setBColOculta(true);
       ...
       //$oDrop2->addItemDropdown($this->addIcone(Base::ICON_INFO) . 'Estoque', 'ConsultaEstoque', 'acaoMostraTelaEstoque', '', false, $_SESSION['officecabsoliten'], true, '',false,'Estoques');
        ...
        $this->addCampos($oBotaoModal,$oOp,$oPeso,$oSitLista,$oTempRev,$oSituacao, $oRetrabalho,$oData,$oRefencia,$oCodigo,$oProdes,$oCliente);
