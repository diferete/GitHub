...
class ViewSTEEL_PCP_Receitas extends View {
    ...
    public function criaConsulta() {
        ...
        $oRecAponta = new CampoConsulta('Rec.Apontada', 'recApont');

        $oCamadaEspessura = new CampoConsulta('Espessura', 'CamadaEspessura');

        $oTempoZinc = new CampoConsulta('T. Zincagem', 'TempoZinc');

        $oPesoCesto = new CampoConsulta('Peso Cesto', 'PesoDoCesto');

        $oGridItens->addCampos($oCod, $oSeq, $oTrat, $oTratDes, $oTemperatura, $oRecAponta, $oCamadaEspessura, $oTempoZinc, $oPesoCesto);
    ...
    public function criaTela() {
        ...
        $oTipoReceita = new Campo('Tipo Receita', 'tipoReceita', Campo::CAMPO_SELECTSIMPLE, 2, 2, 2, 2);
        $oTipoReceita->addItemSelect('', '');
        ...
        $this->addCampos(array($oCod, $oData), array($oPeca, $oMaterial, $oClasse), $oLabel1, array($oBitola, $oTempRev, $oTipoReceita), $oLabel2, $oLabel1, array($oMetanol, $oXigenio, $oNitrogenio, $oAmonia), array($oGpl, $oCo, $oCarbono), $oLabel3, array($oImagem, $oInstTrab, $oProgForno), $oAcao);
    }
