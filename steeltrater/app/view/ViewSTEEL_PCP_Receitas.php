...
class ViewSTEEL_PCP_Receitas extends View {
    ...
    public function criaConsulta() {
        ...
        $oFiltro2 = new Filtro($oCodRec, Filtro::CAMPO_TEXTO, 2, 2, 12, 12, false);
    ...
    public function criaTela() {
        ...
        $this->addCampos(array($oCod, $oData), array($oPeca, $oMaterial, $oClasse), $oLabel1, array($oBitola, $oTempRev), $oLabel2, $oLabel1, array($oMetanol, $oXigenio, $oNitrogenio, $oAmonia), array($oGpl, $oCo, $oCarbono), $oLabel3, array($oImagem, $oInstTrab, $oProgForno), $oAcao);
    }
