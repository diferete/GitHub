...
class ViewSTEEL_PCP_ordensFabApontEnt extends View {
    ...
    public function criaConsulta() {
        ...
        $oDescricaoopfiltro = new Filtro($oOp, Filtro::CAMPO_TEXTO, 5, 5, 12, 12, false);
    ...
    public function criaTela() {
        ...
        $this->addCampos(array($oFornoChoice, $oTurno, $oCodUser, $oUserNome), $oLinha, array($oOp, $oBtnPesqOp, $oSeq), array($oBtnInserir, $oBtnAtualizar, $oFornoDes, $oFornoCod), $oGridEnt);
