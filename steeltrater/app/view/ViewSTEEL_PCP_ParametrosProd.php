...
class ViewSTEEL_PCP_ParametrosProd extends View {
    ...
    public function criaConsulta() {
        ...
        $oFiltro = new Filtro($oParam, Filtro::CAMPO_TEXTO, 6, 6, 12, 12, false);
    ...
    public function criaTela() {
        ...
        $oParam = new Campo('Parâmetro', 'parametro', Campo::TIPO_TEXTO, 5, 5, 12, 12);
        $oValor = new Campo('Valor', 'valor', Campo::CAMPO_SELECTSIMPLE, 5, 5, 12, 12);
        $oValor->addItemSelect('SIM', 'SIM');
        $oValor->addItemSelect('NÃO', 'NÃO');
        $oObs = new Campo('Obs', 'obs', Campo::TIPO_TEXTAREA, 8, 8, 12, 12);
