...
class ViewSTEEL_PCP_GerenciaApont extends View {
    ...
    public function criaConsulta() {
        ...
        $oSeqFiltro = new Filtro($oSeq, Filtro::CAMPO_TEXTO_IGUAL, 1, 1, 12, 12, false);
        $oFornoFiltro = new Filtro($oCodForno, Filtro::CAMPO_TEXTO_IGUAL, 1, 1, 12, 12, false);
        $oCodProdFiltro = new Filtro($oCodProd, Filtro::CAMPO_TEXTO_IGUAL, 1, 1, 12, 12, false);
        $oSituafiltro = new Filtro($oSituacao, Filtro::CAMPO_TEXTO, 2, 2, 12, 12, false);
