...
class ViewSTEEL_PCP_Certificado extends View {
    ...
    public function criaConsulta() {
        ...
        $oFiltroCliente = new Filtro($oEmpDes, Filtro::CAMPO_TEXTO, 3, 3, 12, 12, false);
        $oFiltroNotaSteel = new Filtro($oNotaSteel, Filtro::CAMPO_TEXTO_IGUAL, 1, 1, 12, 12, false);
        $oFiltroNotaCliente = new Filtro($oNotaClient, Filtro::CAMPO_TEXTO_IGUAL, 1, 1, 12, 12, false);
        ...
        $oDrop1->addItemDropdown($this->addIcone(Base::ICON_IMAGEM) . 'Visualizar', 'STEEL_PCP_Certificado', 'acaoMostraRelCertificado', '', false, 'CertificadoOpSteel', false, '', false, '', true, false);
        $oDrop1->addItemDropdown($this->addIcone(Base::ICON_EMAIL) . 'Enviar E-mail', 'STEEL_PCP_Certificado', 'geraPdfCert', '', false, 'CertificadoOpSteel', false, '', false, '', true, false);
    ...
    public function criaTela() {
        ...
        $oAbaPadrao->addCampos(array($oSupDurMin, $oSupDurMax, $oSupEscala), array($oNucDurMin, $oNucDurMax, $oNucEscala), array($oCamDurMin, $oCamDurMax, $oInsEneg)
        );
    ...
    public function criaTelaModal($sDados) {
        ...
        $this->addCampos(array($oNr, $oOp, $oCodProd, $oProduto, $oDataEnsaio), $oTab, $oConclusao, $oBtnInserir
        );
    }
