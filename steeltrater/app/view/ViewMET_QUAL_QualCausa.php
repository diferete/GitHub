...
class ViewMET_QUAL_QualCausa extends View{
    ...
    public function criaTela() {
        ...
        $oCausa = new Campo('Selecione a causa','causa', Campo::TIPO_SELECTMULTI,2);
        ...
        $oCausaDes = new Campo('Informe descrição','causades', Campo::TIPO_TEXTAREA,4);
        $oCausaDes->setILinhasTextArea(5);
        $oCausaDes->setICaracter(500);
        $oCausaDes->setIMarginTop(9);
        ...
        $oPq1 = new Campo('1º Porque','pq1', Campo::TIPO_TEXTAREA,2,2,2,2);
        $oPq1->setILinhasTextArea(5);
        $oPq1->setIMarginTop(9);
        
        $oPq2 = new Campo('2º Porque','pq2', Campo::TIPO_TEXTAREA,2,2,2,2);
        $oPq2->setILinhasTextArea(5);
        $oPq2->setIMarginTop(9);
        
        $oPq3 = new Campo('3º Porque','pq3', Campo::TIPO_TEXTAREA,2,2,2,2);
        $oPq3->setILinhasTextArea(5);
        $oPq3->setIMarginTop(9);
        
        $oPq4 = new Campo('4º Porque','pq4', Campo::TIPO_TEXTAREA,2,2,2,2);
        $oPq4->setILinhasTextArea(3);
        $oPq4->setIMarginTop(9);
        
        $oPq5 = new Campo('5º Porque','pq5', Campo::TIPO_TEXTAREA,2,2,2,2);
        $oPq5->setILinhasTextArea(3);
        $oPq5->setIMarginTop(9);
       
        
        
         $oGridOcorr = new Campo('Ocorrência 6M','6m', Campo::TIPO_GRIDVIEW,2,2,2,2);
