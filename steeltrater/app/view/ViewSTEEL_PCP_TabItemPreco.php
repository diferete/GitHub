...
class ViewSTEEL_PCP_TabItemPreco extends View {
    ...
    public function criaTela() {
        ...
        if ($sAcao == 'acaoAlterar') {
            $oTratcod->setBCampoBloqueado(true);
        }
        ...
        $this->addCampos(array($oNr, $oSeq), array($oRecCod, $oRecdes), array($oCodigo, $oProdes, $oTratcod), array($oTipo, $oNcm), array($oPre, $oBotConf));
