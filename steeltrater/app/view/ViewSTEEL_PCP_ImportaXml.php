...
class viewSTEEL_PCP_ImportaXml extends View {
    ...
    public function criaConsulta() {
        ...
        $oFiltro1 = new Filtro($oNfnro, Filtro::CAMPO_TEXTO_IGUAL, 1, 1, 12, 12, false);
        $oFiltroReferencia = new Filtro($oProcod, Filtro::CAMPO_TEXTO_IGUAL, 2, 2, 12, 12, false);
        $this->addFiltro($oFiltro1, $oFilEmpresa, $oFiltroReferencia);


        $this->addCampos($oBotaoEmitOf, $oSeq, $oOpSteel, $oEmpcod, $oNfnro, $oSerie, $oNfeSeq, $oProcod, $oProdes, $oUn, $oQt, $oVlrUnit, $oVlrTotal, $oNcm, $oOpCliente, $oXped, $oNitemPed);
