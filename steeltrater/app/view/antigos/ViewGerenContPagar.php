...
class ViewGerenContPagar extends View{
    ...
    public function criaConsulta() {
       ...
       // $oEmpcnpj = new CampoConsulta('Empresa','empcnpj');
        ...
        $oDrop1->addItemDropdown($this->addIcone(Base::ICON_CONFIG).'Aponta pagamento','GerenContPagar', 'acaoMostraTelaApontamentos', '',true);
        
        $oDropP2 = new Dropdown('Movimentação', Dropdown::TIPO_INFO);
        $oDropP2->addItemDropdown($this->addIcone(Base::ICON_LOOP).'Retorna Pagamento','GerenContPagar', 'retornoPag', '',false);
