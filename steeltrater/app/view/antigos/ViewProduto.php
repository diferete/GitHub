...
class ViewProduto extends View{
    ...
    public function criaTela() {
        ...
        $this->addCampos(array($oProcod,$oProdes,$oProBloq),array($oGrupo,$oGrupoDes),array($oSubCod,$oSubDes),
                array($oFamcod,$oFamDes),array($oFamsub,$oFamsDes),array($oUnidade,$oPeso,$oClassFiscal,$oCest) );
    }
