...
class PersistenciaParam extends Persistencia{
    public function __construct() {
        parent::__construct();
        
        $this->setTabela('tbparametros');
    ...
    public function liberaEmpenho(){
       $sSql = 'select count(*)as total from tbparametros where codigo = 1 and officecod ='.$_SESSION['repoffice'];
