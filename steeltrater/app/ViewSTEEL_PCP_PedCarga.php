...
class ViewSTEEL_PCP_PedCarga extends View {
    ...
    public function criaTela() {
        ...
        if ((!$sAcaoRotina != null || $sAcaoRotina != 'acaoVisualizar') && ($sAcaoRotina == 'acaoIncluir' || $sAcaoRotina == 'acaoAlterar' )) {
            ...
            $this->addCampos(array($oFilial, $oUseEmiss, $oDataEmiss, $oDataDig, $oNrCarga, $oPedSit, $oPedAprov), $oLabel, $oLabel, array($oOpBase, $oEmp_codigo, $oEmp_des), $oLabel, array($oMovCod, $oMov_des), $oLabel, array($oTabPreco, $oTabPrecoDesc, $oDataEnt, $oMarca, $oEspecie), $oLabel, array($oFrete, $oPesoBruto, $oPesoLiquido, $oVolumes), $oAcao);
        } else {
            $this->addCampos(array($oFilial, $oUseEmiss, $oDataEmiss, $oDataDig, $oNrCarga, $oPedSit, $oPedAprov), $oLabel, $oLabel, array($oOpBase, $oEmp_codigo, $oEmp_des), $oLabel, array($oMovCod, $oMov_des), $oLabel, array($oTabPreco, $oTabPrecoDesc, $oDataEnt, $oMarca, $oEspecie), $oLabel, array($oFrete, $oPesoBruto, $oPesoLiquido, $oVolumes));
        }
    }
