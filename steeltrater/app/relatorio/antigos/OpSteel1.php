...
foreach ($aOps as $key => $aOp) {
    ...
    $pdf->SetFont('Arial','B',9);
    $pdf->Cell(30, 5, '04/07/2018','B,R',0,'L');
...
//ETIQUETA DE IDENTIFICAÇÃO DE RETORNO
    ...
    $pdf->Cell(15, 5, 'Cliente:','L,B',0,'L');
    $pdf->SetFont('Arial','B',9);
    $pdf->Cell(119, 5, 'EJOT-FEY SISTEMAS DE FIXAÇÃO LTDA.','B,R',0,'L');

    //Data de entrada
    $pdf->SetFont('Arial','',9);
    $pdf->Cell(35, 5, 'Data de entrada:','B,B',0,'L');
    $pdf->SetFont('Arial','B',9);
    $pdf->Cell(30, 5, '27/06/2018','B,R',1,'L');
    ...
    $pdf->SetFont('Arial','B',9);
    $pdf->Cell(60, 5, 'NUC= 320 / 380 HV','B,R',0,'L');
    ...
    $pdf->SetFont('Arial','B',9);
    $pdf->Cell(17, 5, '10B22','B,R',1,'L');
    
    //Produto
    $pdf->SetFont('Arial','',9);
    $pdf->Cell(37, 5, 'Produto:','L,B',0,'L');
    $pdf->SetFont('Arial','B',9);
    $pdf->Cell(127, 5, ': PF DELTA PT 30 X 25 WN5451 ZINI','B,R',0,'L');
