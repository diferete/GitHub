 ...
 */
$sFiltroSql =" where (nfindatavenc between '".$dataInicial."' and '".$dataFinal."')";
$sFiltroSql .=" and tbfindup.finsitcod = 1 ";
$sFiltroSql .=" and tbpessoa.empcodigo = 2 order by nfindatavenc";
...
$aParametros[dataInicial] = $dataInicial;
$aParametros[dataFinal] = $dataFinal;
$PHPJasperXML->arrayParameter=$aParametros;
$PHPJasperXML->load_xml_file("RelatorioFinanceiro.jrxml");
