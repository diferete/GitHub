...
$pdf->Cell(79, 5, 'Empresa', 1, 0);
$pdf->Cell(15, 5, 'Comercial', 1, 0);
$pdf->Cell(20, 5, 'Requisito Prod.', 1, 0);
$pdf->Cell(17, 5, 'Embalagem', 1, 0);
$pdf->Cell(10, 5, 'Prazo', 1, 0);
$pdf->Cell(16, 5, 'Expectativa', 1, 0);
$pdf->Cell(14, 5, 'Indicação', 1, 0);
$pdf->Cell(9, 5, 'Seq.', 1, 1);
...
while ($row = $sth->fetch(PDO::FETCH_ASSOC)) {
    ...
    $pdf->Cell(25, 5, $row['empcod'], 1, 0);
    $pdf->Cell(79, 5, $row['empdes'], 1, 0);
    $pdf->Cell(15, 5, $row['comercial'], 1, 0);
    $pdf->Cell(20, 5, $row['prodrequisito'], 1, 0);
    $pdf->Cell(17, 5, $row['prodembalagem'], 1, 0);
    $pdf->Cell(10, 5, $row['prodprazo'], 1, 0);
    $pdf->Cell(16, 5, $row['geralexpectativa'], 1, 0);
    $pdf->Cell(14, 5, $row['geralindica'], 1, 0);
    $pdf->Cell(9, 5, $row['seqrel'], 1, 1);
