...
class ControllerMET_TEC_Usuario extends Controller {

    function __construct() {
        $this->carregaClassesMvc('MET_TEC_usuario');
    }
...
//       $codigo = $aDados['CODIGO']; //Codigo tipo código
    ...
    public function atualizaDadosCracha() {
        $aDados = $this->getArrayCampostela();
        echo '$("#IdCadastroUsuarioCracha").val("' . ltrim($aDados['usucracha'], '0') . '");';
    }
