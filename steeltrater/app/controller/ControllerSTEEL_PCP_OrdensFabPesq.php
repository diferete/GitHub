...
class ControllerSTEEL_PCP_OrdensFabPesq extends Controller{
    public function __construct() {
        $this->carregaClassesMvc('STEEL_PCP_OrdensFabPesq');
    }
   ...
   */
    ...
    public function verificaOp(){
     ...
     public function antesBuscaPk($sDados) {
           ...
           $aParam[0]= 'emp_codigo,'.$oPevDadosCab->getPDV_PedidoEmpCodigo();
           
           $this->View->getTela()->setAParametros($aParam);
       }
