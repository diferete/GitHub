...
/*
 * Implementa a classe controler POL_PCP_Produtos
 * 
 * @author Cleverton Hoffmann
 * @since 15/02/2021
 */

class ControllerPOL_PCP_Produtos extends Controller {

    public function __construct() {
        $this->carregaClassesMvc('POL_PCP_Produtos');
    }
    ...
    public function beforeInsert() {
        ...
        if ($this->Model->getPro_codigo() == null || $this->Model->getPro_codigo() == '') {
            ...
            if ($sSeq == null) {
                $this->Model->setPro_codigo(77770001);
            } else {
        ...
        if ($this->Model->getPro_referencia() !== '' && $this->Model->getPro_codigoantigo() !== '') {
            $oOprodutoRef = Fabrica::FabricarController('POL_PCP_Produtos');
    ...
    public function insertProdutoFilial() {
        ...
        $oProdutoFilial->Model->setFil_codigo('83781641000158');
        ...
        $oProdutoFilial->Model->setPro_filialreferenciaseriefilia('83781641000158');
    ...
    public function buscaReferencia($sDados) {
        ...
        if ($aCampos['emp_codigo'] == '83781641000158') {
