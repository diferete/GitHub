  ...
  public function __construct() {
    ...
    public function beforeInsert() {
        ...
        if($iCont > 0){
            ...
            $oModal = new Modal('Atenção','Código já cadastrado, informe outro códito', Modal::TIPO_AVISO, false,true, false);
    ...
    public function validacaoProdutos(){
        ...
        $aFiltros[0]=9;
        $this->Persistencia->adicionaFiltro('pro_subgrupocodigo', $aFiltros, Persistencia::LIGACAO_AND, Persistencia::GRUPO);
        
        $aFiltros[0]=14;
        $this->Persistencia->adicionaFiltro('pro_familiacodigo', $aFiltros, Persistencia::LIGACAO_AND, Persistencia::GRUPO);
