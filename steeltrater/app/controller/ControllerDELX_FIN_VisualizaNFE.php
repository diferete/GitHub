...
class ControllerDELX_FIN_VisualizaNFE extends Controller {

    public function __construct() {
        $this->carregaClassesMvc('DELX_FIN_VisualizaNFE');
    }
    ...
    public function beforeMostraRelConsulta($sParametros) {
        ...
        if ($oRetorno->nfsnfesit !== 'A') {
            ...
            $sDir = $sDir . '\\' . ltrim(rtrim($oRetorno->nfsnfechv)) . '-nfeProc.xml';
            if (!file_exists($sDir)) {
