...
/*
 * Implementa a classe controler STEEL_PED_Aprovacoes
 * @author Alexandre de Souza
 * @since 18/08/2021
 */

class ControllerSTEEL_PED_Aprovacoes extends Controller {
    ...
    public function criaTelaModalSteelGerenciaPedido($sDados) {
        ...
        $this->Persistencia->adicionaFiltro('sup_pedidoseq', $aCamposChave['SUP_PedidoSeq']);
