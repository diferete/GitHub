...
/* 
 * Implementa a controller para pesquisa de insumos e serviços
 * 
 * @author Avanei Martendal
 * @since 26/03/2109
 */

class ControllerSTEEL_PCP_pesqUsoConsumo  extends Controller{
    public function __construct() {
        $this->carregaClassesMvc('STEEL_PCP_pesqUsoConsumo');
    }
