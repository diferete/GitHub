...
class ControllerMET_QUAL_Ata extends Controller{
    public function __construct() {
        $this->carregaClassesMvc('MET_QUAL_Ata');
    }
    ...
    public function apontAta($sDados){
         ...
         if($aRetorno[0]){
            ...
            echo 'requestAjax("'.$aDados[0].'","MET_QUAL_Ata","getDadosGrid","'.$aDados[1].'","consultaAta");';
