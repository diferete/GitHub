...
class ViewNfRep extends View{
    ...
    public function criaConsulta() {
     ...
     //campos abaixo do grid principal  
       ...
       //filtros
        $oFiltroNota = new Filtro($oNf, Filtro::CAMPO_TEXTO_IGUAL,1);
        $oFiltroCliente = new Filtro($oCliente, Filtro::CAMPO_TEXTO,3);
        $oFiltroData = new Filtro($oNfDataEmi, Filtro::CAMPO_DATA_ENTRE);
        $oFilCnpj = new Filtro($oCliCod, Filtro::CAMPO_BUSCADOBANCOPK,2);
