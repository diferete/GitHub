...
class ViewSTEEL_PCP_OrdensFab extends View{
    public function criaConsulta() {
        ...
        $this->addFiltro($oOpFiltro,$oCodigoFiltro,$oDescricaoFiltro,$oFilEmpresa,$oDocFiltro,$oTipoAcaoFiltro,$oFiltroReferencia,$oOpAntesFiltro,$oFiltroSit);
        ...
        $this->addCampos($oOp,$oBotaoModal,$oBotaoFat,$oSituacao,$oNrCarga,$Pendencia,$oData,$oCodigo,$oReferencia,$oProdes,$oPeso,$oRetrabalho,$oDocumento,$oTipOrdem);
    ...
    public function criaTela() {
       ...
       // $oProdFinal->setBCampoBloqueado(true);
        ...
        $this->addCampos(array($oOp,$oOrigem,$oData,$oHora,$oUser,$oSeqProdNr, $oSituacao),
               ...
               $oLinha,
                array($oOpCli,$oQuant,$oPeso,$oValorUnit,$oValorEnt,$oTempRev),$oLinha,$oObs,$oLinha,
                array($oDataPrev,$oNrCarga,$oXPed,$nItemPed,$oNrcert),$oField1,$oField2);
    }
    ...
    */
    public function RelOpSteel2(){        
       ...
       $this->addCampos(array($oDatainicial, $oDatafinal),$oLinha1,array($oEmp_codigo, $oEmp_des),$oLinha1,array($oSituaRel,$sLabel),$oLinha1,$oXls);
    }
    ...
    public function RelOpSteelForno(){        
       ...
       //Situação
       $oSituaRel = new Campo('Situação', 'situa', Campo::TIPO_SELECT, 2, 2, 12, 12);
      $oSituaRel->addItemSelect('Finalizado', 'Finalizado');  $oSituaRel->addItemSelect('Todas','Todas');
       $oSituaRel->addItemSelect('Finalizado', 'Finalizado');
      $oSituaRel->addItemSelect('Processo', 'Processo');
     ...
     */
     public function RelOpFat(){        
       ...
       //cliente
        ...
        $oSituacao->addItemSelect("Nao Retornado", "Não Retornados");
       
       $this->addCampos(array($oDatainicial, $oDatafinal),$oLinha1,array($oEmp_codigo, $oEmp_des), $oLinha1, $oNotaFiscal, $oLinha1, $oSituacao);
    }
}
