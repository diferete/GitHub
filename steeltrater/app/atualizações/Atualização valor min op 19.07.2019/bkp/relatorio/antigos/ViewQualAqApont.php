...
class ViewQualAqApont extends View {
    ...
    public function criaTela() {
       ...
       $oGridAq->addCampos($oSeq,$oPlano,$oDaPrev,$oDataRealiz,$oSit,$oAnexo);
        ...
        $oPlanEnv = new campo('Plano de ação','plano', Campo::TIPO_TEXTAREA,6,6,6,6);
        ...
        $oObsFim = new Campo('Observação final','obsfim', Campo::TIPO_TEXTAREA,6,6,6,6);
        $oObsFim->setICaracter(1000);
        $oObsFim->setSCorFundo(Campo::FUNDO_AMARELO);
        
        $oAnexoFim = new campo('Anexo','anexofim', Campo::TIPO_UPLOAD,3);
       ...
       //id do grid
        ...
        $this->addCampos(array($oEmpresa,$oNr),$oGridAq,$oSeqEnv,$oPlanEnv,array($oDataFim,$oAnexoFim),array($oObsFim,$oBtnInserir,$oBtnNormal));
