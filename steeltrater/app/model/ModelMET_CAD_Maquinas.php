...
class ModelMET_CAD_Maquinas {
    ...
    function getSTEEL_CCT_CentroCusto() {
        if (!isset($this->STEEL_CCT_CentroCusto)) {
            $this->STEEL_CCT_CentroCusto = Fabrica::FabricarModel('STEEL_CCT_CentroCusto');
        }
        return $this->STEEL_CCT_CentroCusto;
    }
    
    function setSTEEL_CCT_CentroCusto($STEEL_CCT_CentroCusto) {
        $this->STEEL_CCT_CentroCusto = $STEEL_CCT_CentroCusto;
    }
