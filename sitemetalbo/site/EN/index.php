          ...
          <div class="span10 margemTop50"> <!-- DIV DO CORPO DO SITE *FECHADA-->
           ...
           <div class="row-fluid"> <!-- LINHA DA DIV DO CORPO DO SITE*FECHADA -->
            <div class="span4" >  <!-- DIV EXELENCIA FABRICAÇÃO *FECHADA -->
              ...
              <p><a class="btn btn-success btn-large"  href="factory.php">GET TO KNOW OUR FACTORY!</a></p>
            ...
            <div class="span4"><!--INICIO DA DIV BRASIL E AMERICA LATINA *FECHADA-->  
              ...
              <p><a class="btn btn-success btn-large" href="expedition.php">GET TO KNOW OUR SHIPPING SYSTEM!</a></p>
            </div><!--FIM DA DIV BRASIL E AMERICA-->
            <div class="span4"><!--INICIO DA DIV CERTIFICADA *FECHADA-->
              <h2 class="corPadrao">ISO 9001 CERTIFICATION</h2>
              ...
              <li>
                <div class="thumbnail">
                  ...
                  <div class="caption">
                    ...
                    <p><a href="http://www.metalbosp.com.br/" target="new" class="btn btn-success btn-large">VISIT OUR SITE!</a> </p>
                    </div>
                </div>
              </li>
              </ul>
                ...
                <div class="thumbnail">
                 <img src="images/Logo Handel.jpg">
                  <div class="caption">
                    ...
                    <p><a href="http://handel.com.ar/" target="new" class="btn btn-success btn-large">VISIT OUR SITE!</a> </p>
                  </div>
                </div>
              </li>
              </ul>
              ...
              <li>
                <div class="thumbnail">
                 ...
                 <div class="caption">
                    ...
                    <p><a href="representantes.php?link=4" class="btn btn-success btn-large">ENTER YOUR REGION!
                    </a> </p>
                  </div>
                </div>
              </li>
