    	...
    	<div class="row-fluid">
			...
			<div class="span6 margemTop50">
                ...
                <div class="panel-heading">
                  <h4 class="corPadrao"> CONTACT A METALBO </h4>
                </div>
                   <div class="panel-body">
                     <form class="form-horizontal" name="formcontato" id="formcontato">
                        <div class="control-group">
                            <label class="control-label">Talk to:</label>
                                <div class="controls">
                                    <select name="id_falarcom" id="id_falarcom">
                                        <option>Choose the sector...</option>
                                        <option value="vendas">Sales</option>
                                        <option value="compras">Purchasing</option>
                                        <option value="qual">Quality</option>
                                    </select>
                                    <span class="erro alert-error" id="id_falarcom-erro">Write one sector!</span>
                                </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" >NAME:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_nome-erro">Write one name!</span>
                        ...
                        <div class="control-group">
                            <label class="control-label" >COMPANY:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_empresa-erro">Write one company!</span> 
                                </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label">EMAIL:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_email-erro">Write one email!</span>
                                </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label">CITY:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_cidade-erro">Write one city!</span> 
                                </div>
                            ...
                            <label class="control-label">ESTATE:</label>
                                <div class="controls">
                                    <select name="id_estado" id="id_estado">
                                        ...
                                        <option value="EX">Not is brazilian</option>
                                    </select>
                                    <span class="erro alert-error" id="id_estado-erro">Write one state!</span>
                                </div>
                           </div>
                           <div class="control-group">
                            <label class="control-label">PHONE:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_telefone-erro">Write one phone number!</span> 
                                </div>
                                
                          </div>
                          
                          <div class="control-group">
                            <label class="control-label" for="inputEmail" >COMENT:</label>
                            <div class="controls">
                              <textarea rows="10" style="width:400px" name="id_comem" id="id_comem"></textarea><br/>
                              <span class="erro alert-error" id="id_comem-erro">Write one comment!</span> 
                            </div>
                          </div>
                       <hr />
                       <div class="control-group">
                        <div class="controls">
                          <a href="#" class="btn btn-success"  id="atualiza">Send data!</a> 
                        </div>
                      </div>
...
<iframe width="300" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.br/maps?f=q&amp;source=s_q&amp;hl=pt-BR&amp;geocode=&amp;q=Rex+M%C3%A1quinas+Equipamentos,+Trombudo+Central+-+Santa+Catarina&amp;aq=t&amp;sll=-27.185355,-49.622769&amp;sspn=0.363422,0.676346&amp;ie=UTF8&amp;hq=Rex+M%C3%A1quinas+Equipamentos,&amp;hnear=Trombudo+Central+-+Santa+Catarina&amp;t=h&amp;ll=-27.286176,-49.784031&amp;spn=0.005721,0.006437&amp;z=16&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.br/maps?f=q&amp;source=embed&amp;hl=pt-BR&amp;geocode=&amp;q=Rex+M%C3%A1quinas+Equipamentos,+Trombudo+Central+-+Santa+Catarina&amp;aq=t&amp;sll=-27.185355,-49.622769&amp;sspn=0.363422,0.676346&amp;ie=UTF8&amp;hq=Rex+M%C3%A1quinas+Equipamentos,&amp;hnear=Trombudo+Central+-+Santa+Catarina&amp;t=h&amp;ll=-27.286176,-49.784031&amp;spn=0.005721,0.006437&amp;z=16" style="color:#0000FF;text-align:left">View larger map</a></small>
         </div>
         ...
         <div class="span3 margemTop25">
			...
			<div class="panel panel-default corPadrao">
                ...
                <div class="panel-body">
                    ...
                    SC - BRASIL<br>
                    Code ZIP: 89176-000<br>
                    <abbr title="Phone">Phone:</abbr> 55 (47) 3544-8400 <br/>
