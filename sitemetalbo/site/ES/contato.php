    	...
    	<div class="row-fluid">
                   ...
                   <div class="panel-body">
                     <form class="form-horizontal" name="formcontato" id="formcontato">
                        <div class="control-group">
                            <label class="control-label">Hablar con:</label>
                                <div class="controls">
                                    <select name="id_falarcom" id="id_falarcom">
                                        <option>Escolha o Setor...</option>
                                        <option value="vendas">Ventas</option>
                                        <option value="compras">Compras</option>
                                        <option value="qual">Calidad</option>
                                    </select>
                                    <span class="erro alert-error" id="id_falarcom-erro">Por favor rellene un sector!</span>
                                </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" >NOMBRE:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_nome-erro">El nombre completo por favor!</span>
                        ...
                        <div class="control-group">
                            <label class="control-label" >EMPRESA:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_empresa-erro">Rellene el negocio, por favor!</span> 
                                </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label">EMAIL:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_email-erro">Por favor, rellene por favor correo electrónico!</span>
                                </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label">CIUDAD:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_cidade-erro">Por favor, rellene una ciudad!</span> 
                                </div>
                        ...
                        <div class="control-group">
                            <label class="control-label">ESTADO:</label>
                                <div class="controls">
                                    <select name="id_estado" id="id_estado">
                                        ...
                                        <option value="EX">Nos es brasileño?</option>
                                    </select>
                                    <span class="erro alert-error" id="id_estado-erro">Llenar un estado, por favor!</span>
                                </div>
                           </div>
                           <div class="control-group">
                            <label class="control-label">TELEFÓNO:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_telefone-erro">Llenar un teléfono por favor!</span> 
                                </div>
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              ...
                              <span class="erro alert-error" id="id_comem-erro">Rellene lo que quieres, por favor!</span> 
                            </div>
                          </div>
                       <hr />
                       <div class="control-group">
                        <div class="controls">
                          <a href="#" class="btn btn-success"  id="atualiza">ENVIAR DATOS!</a> 
                        </div>
                      </div>
         ...
         <div class="span3 margemTop50">
             <div class="alert alert-success">
				REVISE NUESTRA UBICACIÓN            
             </div>
<iframe width="300" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.br/maps?f=q&amp;source=s_q&amp;hl=pt-BR&amp;geocode=&amp;q=Rex+M%C3%A1quinas+Equipamentos,+Trombudo+Central+-+Santa+Catarina&amp;aq=t&amp;sll=-27.185355,-49.622769&amp;sspn=0.363422,0.676346&amp;ie=UTF8&amp;hq=Rex+M%C3%A1quinas+Equipamentos,&amp;hnear=Trombudo+Central+-+Santa+Catarina&amp;t=h&amp;ll=-27.286176,-49.784031&amp;spn=0.005721,0.006437&amp;z=16&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.br/maps?f=q&amp;source=embed&amp;hl=pt-BR&amp;geocode=&amp;q=Rex+M%C3%A1quinas+Equipamentos,+Trombudo+Central+-+Santa+Catarina&amp;aq=t&amp;sll=-27.185355,-49.622769&amp;sspn=0.363422,0.676346&amp;ie=UTF8&amp;hq=Rex+M%C3%A1quinas+Equipamentos,&amp;hnear=Trombudo+Central+-+Santa+Catarina&amp;t=h&amp;ll=-27.286176,-49.784031&amp;spn=0.005721,0.006437&amp;z=16" style="color:#0000FF;text-align:left">Ver mapa más grande</a></small>
         </div>
         ...
         <div class="span3 margemTop25">
			...
			<div class="panel panel-default corPadrao">
                ...
                <div class="panel-body">
                    ...
                    SC - BRASIL<br>
                    CP: 89176-000<br>
                    <abbr title="Phone">Teléfono:</abbr> 55 (47) 3544-8400 <br/>
                    <abbr title="Phone">Fax:</abbr> 55 (47) 3544-0396
                    <address><br />
					<strong>Email para Contacto</strong><br>
