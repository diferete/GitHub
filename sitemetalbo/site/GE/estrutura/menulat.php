...
<div id="menu">
   <ul class="menu">
    <li><a href="precos.php" >PREISLISTE</a></li>
    <li><a href="noticias.php" >NEUIGKEITEN</a></li>
    <li><a href="representantes.php?link=4" >REPRESENTANTES </a></li>
    <li><a href="fabrica.php" >INDUSTRIEPARK</a></li>
    <li><a href="expedicao.php" >VERSAND</a></li>
