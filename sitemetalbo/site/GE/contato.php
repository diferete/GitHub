    	...
    	<div class="row-fluid">
			...
			<div class="span6 margemTop50">
                ...
                <div class="panel-heading">
                  <h4 class="corPadrao"> KONTAKTIEREN SIE METALBO </h4>
                </div>
                   <div class="panel-body">
                     <form class="form-horizontal" name="formcontato" id="formcontato">
                        <div class="control-group">
                            <label class="control-label">SPRECHEN MIT:</label>
                                <div class="controls">
                                    <select name="id_falarcom" id="id_falarcom">
                                        <option>Select Sector...</option>
                                        <option value="vendas">Vertrieb</option>
                                        <option value="compras">Einkauf</option>
                                        <option value="qual">Qualität</option>
                                    </select>
                                    <span class="erro alert-error" id="id_falarcom-erro">Bitte füllen Sie in einem Sektor!</span>
                                </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label" >NAME:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_nome-erro">Füllen Sie bitte den vollständigen Namen!</span>
                        ...
                        <div class="control-group">
                            <label class="control-label" >UNTERNEHMEN:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_empresa-erro">Füllen Sie das Geschäft, bitte!</span> 
                                </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label">EMAIL:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_email-erro">Bitte füllen Sie bitte per E-Mail!</span>
                                </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label">STADT:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_cidade-erro">Bitte füllen Sie in einer Stadt!</span> 
                                </div>
                                
                        </div>
                        
                        <div class="control-group">
                            <label class="control-label">STAAT:</label>
                                <div class="controls">
                                    <select name="id_estado" id="id_estado">
                                        ...
                                        <option value="GE">Es gibt brasilianische?</option>
                                    </select>
                                    <span class="erro alert-error" id="id_estado-erro">Füllen Sie einen Zustand bitte!</span>
                                </div>
                           </div>
                           <div class="control-group">
                            <label class="control-label">TELEFON:</label>
                                <div class="controls">
                                    ...
                                    <span class="erro alert-error" id="id_telefone-erro">Füllen Sie ein Telefon bitte!</span> 
                                </div>
                                
                          </div>
                          
                          <div class="control-group">
                            <label class="control-label" for="inputEmail" >MITTEILUNG:</label>
                            <div class="controls">
                              <textarea rows="10" style="width:400px" name="id_comem" id="id_comem"></textarea><br/>
                              <span class="erro alert-error" id="id_comem-erro">Füllen Sie bitte einen Kommentar!</span> 
                            </div>
                          </div>
                       <hr />
                       <div class="control-group">
                        <div class="controls">
                          <a href="#" class="btn btn-success"  id="atualiza">SENDEN!</a> 
                        </div>
                      </div>
         ...
         <div class="span3 margemTop50">
             <div class="alert alert-success">
				FINDEN SIE UNSEREN STANDORT           
             </div>
<iframe width="300" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.br/maps?f=q&amp;source=s_q&amp;hl=pt-BR&amp;geocode=&amp;q=Rex+M%C3%A1quinas+Equipamentos,+Trombudo+Central+-+Santa+Catarina&amp;aq=t&amp;sll=-27.185355,-49.622769&amp;sspn=0.363422,0.676346&amp;ie=UTF8&amp;hq=Rex+M%C3%A1quinas+Equipamentos,&amp;hnear=Trombudo+Central+-+Santa+Catarina&amp;t=h&amp;ll=-27.286176,-49.784031&amp;spn=0.005721,0.006437&amp;z=16&amp;output=embed"></iframe><br /><small><a href="https://maps.google.com.br/maps?f=q&amp;source=embed&amp;hl=pt-BR&amp;geocode=&amp;q=Rex+M%C3%A1quinas+Equipamentos,+Trombudo+Central+-+Santa+Catarina&amp;aq=t&amp;sll=-27.185355,-49.622769&amp;sspn=0.363422,0.676346&amp;ie=UTF8&amp;hq=Rex+M%C3%A1quinas+Equipamentos,&amp;hnear=Trombudo+Central+-+Santa+Catarina&amp;t=h&amp;ll=-27.286176,-49.784031&amp;spn=0.005721,0.006437&amp;z=16" style="color:#0000FF;text-align:left">VERGRÖSSERTE LANDKARTE ZEIGEN</a></small>
         </div>
         ...
         <div class="span3 margemTop25">
			...
			<div class="panel panel-default corPadrao">
                ...
                <div class="panel-body">
                    ...
                    SC - BRASIL<br>
                    CEP: 89176-000<br>
                    <abbr title="Phone">Telefon:</abbr> 55 (47) 3544-8400 <br/>
                    <abbr title="Phone">Fax:</abbr> 55 (47) 3544-0396
                    <address><br />
					<strong>Email Kontakt</strong><br>
