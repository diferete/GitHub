...
if (!empty($_POST["cortesia"]) 
	&& !empty($_POST["receptividade"]) 
	&& !empty($_POST["qualidade"]) 
	&& !empty($_POST["contato"]) 
	&& !empty($_POST["aspectos_visuais"]) 
	&& !empty($_POST["especificacoes"]) 
	&& !empty($_POST["embalagens"]) 
	&& !empty($_POST["prazo"])
	&& !empty($_POST["iso"])
	&& !empty($_POST["nome"])
	&& !empty($_POST["empresa"])
	...
	//$pra_quem = "avaneim@gmail.com, jaques@rexmaquinas.com.br, pesquisa@rexmaquinas.com.br, damatec@gmail.com, suporte@infodigitalle.com.br";
	//$pra_quem = "pesquisa@metalbo.com.br";
	$pra_quem = "alisson@metalbo.com.br,pesquisa@metalbo.com.br";
...
*/
	...
	$headers ="From: ".$empresa."<jaques@metalbo.com.br>\n"; //Observe que eu utilizei o header 'From' que é um header padrão.
    $headers.="X-Sender:<".$email.">\n";
    $headers.="X-mailer: PHP\n";
    $headers.="X-Priority: 1\n";
    $headers.="Return-path: <jaques@metalbo.com.br>\n";
