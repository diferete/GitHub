...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pesquisa de Satisfa√ß√£o - Metalbo</title>
                        ...
                        <td><center>
                                <p>
                                    ...
                                    if (!empty($_POST["cortesia"]) && !empty($_POST["receptividade"]) && !empty($_POST["qualidade"]) && !empty($_POST["contato"]) && !empty($_POST["aspectos_visuais"]) && !empty($_POST["especificacoes"]) && !empty($_POST["embalagens"]) && !empty($_POST["prazo"])/* && !empty($_POST["iso"]) */ && !empty($_POST["nome"]) && !empty($_POST["empresa"]) && !empty($_POST["email"])) {
                                        ...
                                        // Criando a vari√°vel adicional de headers

                                        $headers = "From: " . $empresa . "<" . $email . ">\n"; //Observe que eu utilizei o header 'From' que √© um header padr√£o.
                                        ...
                                        /*
                                          $headers = "From: "; //Observe que eu utilizei o header 'From' que √© um header padr√£o.
                                          $headers .= $empresa;
                                          $headers .= " <";
                                          $headers .= $email;
                                          $headers .= ">";
                                         */
                                        if (mail("$pra_quem", "Pesquisa de SatisfaÁ„o - 2018", $msg, $headers)) {
                                            ?>
                                            ...
                                            <div class="container-fluid">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span9 corPadrao margemTop50 alert alert-success">
                                                        ...
                                                        <br /><br />
                                                        <h3>A METALBO AGRADECE PELA SUA ATEN«√O!</h3>    
                                                    </div> <!--FIM SPAN 10 -->       
                                                </div><!--FIM ROW-->
                                            </div><!--FIM CONTAINER-->
